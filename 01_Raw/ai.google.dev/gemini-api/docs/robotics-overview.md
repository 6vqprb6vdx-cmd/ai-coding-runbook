...
เอกสารนี้จะอธิบาย[สิ่งที่โมเดลทำ](#how-it-works)และพาคุณไปดู[ตัวอย่าง](#standard-spatial-reasoning)หลายรายการที่เน้นความสามารถด้าน Agentic AI ของโมเดล

หากต้องการเริ่มใช้งานเลย คุณสามารถลองใช้โมเดลใน Google AI Studio ได้

[ลองใช้ใน Google AI Studio](https://aistudio.google.com/prompts/new_chat?model=gemini-robotics-er-1.6-preview&hl=th)
...
ตัวอย่างต่อไปนี้แสดงกรณีการใช้งานหุ่นยนต์ทั่วไป โดยจะแสดงวิธีส่งรูปภาพและพรอมต์ข้อความไปยังโมเดลโดยใช้เมธอด [`generateContent`](https://ai.google.dev/api/generate-content?hl=th#method:-models.generatecontent) เพื่อรับรายการออบเจ็กต์ที่ระบุพร้อมจุด 2 มิติที่เกี่ยวข้อง
...
อ่านเพิ่มเติมเกี่ยวกับวิธีการเรียกใช้ฟังก์ชันด้วย Gemini ได้ใน[หน้าการเรียกใช้ฟังก์ชัน](https://ai.google.dev/gemini-api/docs/function-calling?example=meeting&hl=th#how-it-works)
...
ดูข้อมูลเพิ่มเติมเกี่ยวกับงบประมาณการคิดได้ที่หน้าความสามารถหลักของ[การคิด](https://ai.google.dev/gemini-api/docs/thinking?hl=th)
...
ไปที่หน้า[การทำความเข้าใจรูปภาพ](https://ai.google.dev/gemini-api/docs/image-understanding?hl=th)เพื่อดูเทคนิคการประมวลผลรูปภาพอื่นๆ

### การติดตามออบเจ็กต์ในวิดีโอ

นอกจากนี้ Gemini Robotics-ER 1.6 ยังวิเคราะห์เฟรมวิดีโอเพื่อติดตามออบเจ็กต์
เมื่อเวลาผ่านไปได้ด้วย ดูรายการรูปแบบวิดีโอที่รองรับได้ที่[อินพุตวิดีโอ](https://ai.google.dev/gemini-api/docs/video-understanding?hl=th#supported-formats)
...
[สูตรการทำอาหารสำหรับหุ่นยนต์](https://github.com/google-gemini/robotics-samples/blob/main/Getting%20Started/gemini_robotics_er.ipynb)
...
หุ่นยนต์](https://github.com/google-gemini/robotics-samples/blob/main/Getting%20Started/gemini_robotics_er.ipynb)
หน้า[การทำความเข้าใจรูปภาพ](https://ai.google.dev/gemini-api/docs/image-understanding?hl=th)ยังมี
...
โค้ดที่เรียกใช้ได้ทั้งหมดจะอยู่ใน[ตำราการทำอาหารสำหรับหุ่นยนต์](https://github.com/google-gemini/robotics-samples/blob/main/Getting%20Started/gemini_robotics_er.ipynb) เช่นเดียวกับตัวอย่างอื่นๆ ในหน้านี้
...
ดูข้อมูลโดยละเอียดเกี่ยวกับการกำหนดราคาและภูมิภาคที่พร้อมให้บริการได้ในหน้า[การกำหนดราคา](https://ai.google.dev/gemini-api/docs/pricing?hl=th)
...
- สำรวจความสามารถอื่นๆ และทดลองใช้พรอมต์และอินพุตต่างๆ ต่อไป
  ...
  ดูตัวอย่างเพิ่มเติมได้ที่ [Robotics getting started colab](https://github.com/google-gemini/robotics-samples/blob/main/Getting%20Started/gemini_robotics_er.ipynb)
- ดูข้อมูลเกี่ยวกับวิธีสร้างโมเดลหุ่นยนต์ Gemini โดยคำนึงถึงความปลอดภัยได้ที่[หน้าความปลอดภัยด้านหุ่นยนต์ของ Google DeepMind](https://deepmind.google/models/gemini-robotics/safety?hl=th)
- อ่านข้อมูลอัปเดตล่าสุดเกี่ยวกับโมเดล Gemini Robotics ได้ที่[หน้า Landing Page ของ Gemini Robotics](https://deepmind.google/robotics?hl=th)
...
[[["เข้าใจง่าย","easyToUnderstand","thumb-up"],["แก้ปัญหาของฉันได้","solvedMyProblem","thumb-up"],["อื่นๆ","otherUp","thumb-up"]],[["ไม่มีข้อมูลที่ฉันต้องการ","missingTheInformationINeed","thumb-down"],["ซับซ้อนเกินไป/มีหลายขั้นตอนมากเกินไป","tooComplicatedTooManySteps","thumb-down"],["ล้าสมัย","outOfDate","thumb-down"],["ปัญหาเกี่ยวกับการแปล","translationIssue","thumb-down"],["ตัวอย่าง/ปัญหาเกี่ยวกับโค้ด","samplesCodeIssue","thumb-down"],["อื่นๆ","otherDown","thumb-down"]],["อัปเดตล่าสุด 2026-05-01 UTC"],[],[]]

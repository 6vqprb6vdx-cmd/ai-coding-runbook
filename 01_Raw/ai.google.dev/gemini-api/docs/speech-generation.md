---
source_url: https://ai.google.dev/gemini-api/docs/speech-generation?hl=hi
fetched_at: 2026-08-03T04:27:52.369039+00:00
title: "\u0932\u093f\u0916\u0947 \u0917\u090f \u0936\u092c\u094d\u0926\u094b\u0902 \u0915\u094b \u0938\u0941\u0928\u0928\u0947 \u0915\u0940 \u0938\u0941\u0935\u093f\u0927\u093e (\u091f\u0940\u091f\u0940\u090f\u0938) \u00a0|\u00a0 Gemini API \u00a0|\u00a0 Google AI for Developers"
---
...
पक्का करें कि आपने Gemini 2.5 मॉडल के ऐसे वैरिएंट का इस्तेमाल किया हो जिसमें Gemini की टेक्स्ट-टू-स्पीच (टीटीएस) की सुविधा उपलब्ध हो. इसके बारे में [साथ काम करने वाले मॉडल](https://ai.google.dev/gemini-api/docs/speech-generation?hl=hi#supported-models) सेक्शन में बताया गया है. सबसे अच्छे नतीजों के लिए, यह तय करें कि आपके इस्तेमाल के हिसाब से कौनसा मॉडल सबसे सही है.
...
प्रॉपर्टी का इस्तेमाल किया जा सकता है. यह प्रॉपर्टी, जनरेट किए गए आखिरी ऑडियो ब्लॉक को वापस लाती है. सुविधा से जुड़ी प्रॉपर्टी के बारे में ज़्यादा जानने के लिए, [इंटरैक्शन की खास जानकारी](https://ai.google.dev/gemini-api/docs/interactions-overview?hl=hi#convenience-properties) देखें.
...
एक या एक से ज़्यादा स्पीकर के लिए, टीटीएस की स्टाइल, टोन, लहजे, और रफ़्तार को कंट्रोल किया जा सकता है. इसके लिए, नैचुरल लैंग्वेज प्रॉम्प्ट का इस्तेमाल करें.
...
`stream: true` को सेट करके, मॉडल से जनरेट हो रहे ऑडियो को स्ट्रीम किया जा सकता है.
...
**Gemini के नेटिव ऑडियो जनरेशन की सुविधा के साथ काम करने वाला टेक्स्ट-टू-स्पीच (टीटीएस)** मॉडल, सामान्य टीटीएस मॉडल से अलग है. यह लार्ज लैंग्वेज मॉडल का इस्तेमाल करता है. इस मॉडल को ***यह न सिर्फ़ पता होता है कि क्या बोलना है, बल्कि यह भी पता होता है कि कैसे बोलना है***.
...
इस सुविधा को अनलॉक करने के लिए, उपयोगकर्ता खुद को डायरेक्टर के तौर पर देख सकते हैं. वे वर्चुअल वॉइस टैलेंट के लिए एक सीन सेट कर रहे हैं, ताकि वह परफ़ॉर्म कर सके. प्रॉम्प्ट बनाने के लिए, हम इन कॉम्पोनेंट का इस्तेमाल करने का सुझाव देते हैं: **ऑडियो प्रोफ़ाइल**, जो किरदार की मुख्य पहचान और टाइप को तय करती है; **सीन का ब्यौरा**, जो माहौल और भावनाओं को तय करता है; और **डायरेक्टर के नोट**, जो स्टाइल, लहजे, और गति को कंट्रोल करने के बारे में ज़्यादा सटीक जानकारी देते हैं.

बारीकी से निर्देश देने पर, उपयोगकर्ता मॉडल की कॉन्टेक्स्ट अवेयरनेस का फ़ायदा उठा सकते हैं.जैसे, किसी खास क्षेत्र की बोली, पैरालिंग्विस्टिक की खास विशेषताएं (जैसे, सांस लेने की आवाज़) या गति. इससे, डाइनैमिक, स्वाभाविक, और भावपूर्ण ऑडियो परफ़ॉर्मेंस जनरेट की जा सकती हैं. बेहतर परफ़ॉर्मेंस के लिए, हमारा सुझाव है कि **ट्रांसक्रिप्ट** और डायरेक्टर के प्रॉम्प्ट एक जैसे हों, *ताकि "कौन बोल रहा है"*, *"क्या कहा जा रहा है"*, और *"कैसे कहा जा रहा है"* से मेल खाए.

इस गाइड का मकसद, Gemini की टीटीएस ऑडियो जनरेशन सुविधा का इस्तेमाल करके ऑडियो अनुभव डेवलप करते समय, बुनियादी दिशा-निर्देश देना और आइडिया जनरेट करना है. हमें आपके क्रिएटिव कॉन्टेंट का बेसब्री से इंतज़ार है!
...
टैग की मदद से, ट्रांसक्रिप्ट की डिलीवरी को तुरंत कंट्रोल किया जा सकता है. ज़्यादा कंट्रोल के लिए, इन्हें कॉन्टेक्स्ट प्रॉम्प्ट के साथ मिलाकर इस्तेमाल किया जा सकता है. इससे परफ़ॉर्मेंस की टोन और वाइब सेट की जा सकती है.
...
चुने गए ऐक्सेंट के बारे में जानकारी दो. प्रॉम्प्ट में जितनी ज़्यादा जानकारी दी जाएगी, नतीजे उतने ही बेहतर होंगे. उदाहरण के लिए, "*ब्रिटिश लहजा, जैसा कि क्रॉयडन, इंग्लैंड में सुना जाता है*" का इस्तेमाल करें, न कि "*ब्रिटिश लहजा*" का.
...
- `gemini-3.1-flash-tts-preview` का इस्तेमाल करने के अलावा, टीटीएस की सुविधा स्ट्रीमिंग के साथ काम नहीं करती.
...
- **कभी-कभी टेक्स्ट टोकन मिलते हैं:** मॉडल कभी-कभी ऑडियो टोकन के बजाय टेक्स्ट टोकन देता है. इस वजह से, सर्वर `500` गड़बड़ी के साथ अनुरोध को पूरा नहीं कर पाता. ऐसा बहुत कम अनुरोधों में होता है. इसलिए, आपको अपने ऐप्लिकेशन में, अपने-आप फिर से कोशिश करने का लॉजिक लागू करना चाहिए, ताकि इन अनुरोधों को हैंडल किया जा सके.

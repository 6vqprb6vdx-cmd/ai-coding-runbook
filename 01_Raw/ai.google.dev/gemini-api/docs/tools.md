...
fetched_at: 2026-08-31T06:38:13.185564+00:00
...
[기본 제공 도구와 커스텀 도구 (함수 호출)를 결합하는 요청의 경우 모델은 도구 컨텍스트 순환을 사용하여 여러 환경에서 실행을 조정합니다.](https://ai.google.dev/gemini-api/docs/tool-combination?hl=ko)

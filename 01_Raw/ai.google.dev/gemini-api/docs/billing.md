...
fetched_at: 2026-05-18T12:58:58.634515+00:00
...
अपने ऐप्लिकेशन को सीधे तौर पर बिल्ड मोड से डिप्लॉय करने के लिए, **Google Cloud Starter Tier** का इस्तेमाल किया जा सकता है.
इस टियर में, Google Cloud प्रोजेक्ट या बिलिंग खाता सेट अप किए बिना, दो फ़ुल स्टैक ऐप्लिकेशन पब्लिश किए जा सकते हैं.
ज़्यादा जानकारी के लिए, [Google AI Studio से डिप्लॉय करना](https://ai.google.dev/gemini-api/docs/deploying?hl=hi) लेख पढ़ें. साथ ही, ज़्यादा जानकारी के लिए [Google Cloud के स्टार्टर टियर का दस्तावेज़](https://docs.cloud.google.com/docs/starter-tier?hl=hi) देखें.

ज़्यादा दर सीमाएं ऐक्सेस करने, ऐडवांस मॉडल इस्तेमाल करने, और यह पक्का करने के लिए कि आपके प्रॉम्प्ट और जवाबों का इस्तेमाल Google के प्रॉडक्ट को बेहतर बनाने के लिए **न** किया जाए\*, [बिलिंग खाता लिंक करें](#setup-billing) और [एडवांस में पेमेंट करें](#prepay). इससे आपको पैसे चुकाकर इस्तेमाल की जाने वाली सुविधाएं मिलेंगी.
...
टियर, दर की सीमाएं, और बिलिंग खाते की सीमाएं, सभी [बिलिंग खाते](#cloud-billing) के लेवल पर तय की जाती हैं.
...
1. AI Studio के [एपीआई पासकोड](https://aistudio.google.com/api-keys?hl=hi) पेज, [प्रोजेक्ट](https://aistudio.google.com/projects?hl=hi) पेज या AI Studio में मौजूद **बिलिंग सेट अप करें** बटन पर जाएं.
   ...
   - अगर आपको नई कुंजी की ज़रूरत है, तो [**एपीआई कुंजी बनाएं**](https://aistudio.google.com/api-keys?hl=hi) पर क्लिक करें
     और टेबल में कुंजी-प्रोजेक्ट का जोड़ा जोड़ने के लिए, डायलॉग बॉक्स में दिए गए निर्देशों का पालन करें.
...
[AI Studio की बिलिंग](https://aistudio.google.com/billing?hl=hi) पेज पर, *उपलब्ध क्रेडिट* कार्ड में जाकर, अपने-आप रिलोड होने की सुविधा सेट अप की जा सकती है. साथ ही, इस सुविधा की स्थिति देखी जा सकती है. पेमेंट का तरीका, रीलोड की रकम, और रीलोड पेमेंट को ट्रिगर करने वाला
...
नए प्रोजेक्ट के लिए [बिलिंग सेट अप करते समय](#setup-billing), अगर आपको पोस्टपे की सुविधा मिली है, तो आपके पास [बिलिंग सेटअप](#setup-billing) डायलॉग में, प्रीपे और पोस्टपे में से किसी एक को चुनने का विकल्प होगा.

किसी Cloud Billing खाते को पोस्टपे बिलिंग प्लान पर स्विच करने के बाद, उस बिलिंग खाते से लिंक किए गए सभी प्रोजेक्ट, पोस्टपे प्लान पर स्विच हो जाते हैं. उस बिलिंग खाते को, प्रीपे बिलिंग प्लान पर वापस नहीं ले जाया जा सकता. किसी प्रोजेक्ट के लिए शुल्क लेने की अवधि बदलने के लिए, उसे किसी ऐसे बिलिंग खाते में ट्रांसफ़र किया जा सकता है जिसमें कोई दूसरा बिलिंग प्लान हो. [प्रोजेक्ट के लिए बिलिंग मैनेज करने](https://docs.cloud.google.com/billing/docs/how-to/modify-project?hl=hi) के बारे में जानने के लिए, Cloud का दस्तावेज़ पढ़ें.
...
यह तब काम आता है, जब आपके पास एक ही बिलिंग खाते से जुड़े कई प्रोजेक्ट हों और आपको यह पक्का करना हो कि हर प्रोजेक्ट के पास, कुल खर्च की सीमा का ज़रूरत के मुताबिक हिस्सा हो.
...
AI Studio में बिलिंग डेटा प्रोसेस होने में थोड़ा समय लग सकता है. इसमें करीब 10 मिनट लग सकते हैं. अगर बिलिंग डेटा को प्रोसेस नहीं किया जाता है, तो प्रोजेक्ट की सीमा से ज़्यादा शुल्क लग सकता है.
...
बिलिंग के सिग्नल और अपडेट, हमेशा रीयल टाइम में नहीं होते.
...
**प्रीपेड खाते को पोस्टपेड खाते में स्विच करने पर** (जब [ज़रूरी शर्तें](#about-billing) पूरी कर ली जाती हैं और खाते को [मैन्युअल तरीके से अपग्रेड](#postpay) कर लिया जाता है), प्रीपेड खाता बंद हो जाता है. साथ ही, बचे हुए प्रीपेड क्रेडिट का रिफ़ंड, फ़ाइल में मौजूद पेमेंट के तरीके में अपने-आप भेज दिया जाता है.
...
### मुझसे किस बात के लिए बिल लिया जाता है?
...
### क्या ईईए (इसमें ईयू भी शामिल है), यूके, और सीएच में Gemini API का इस्तेमाल मुफ़्त में किया जा सकता है?
...
### क्या Gemini API के साथ, Google Cloud का वेलकम क्रेडिट इस्तेमाल किया जा सकता है?
...
अगर आपको Google Cloud का वेलकम क्रेडिट, ज़रूरी शर्तें पूरी न करने से पहले मिला था, तो आपको Gemini API और AI Studio पर बचे हुए क्रेडिट खर्च करने की अनुमति है. हालांकि, क्रेडिट की समयसीमा खत्म होने के बाद (90 दिनों के बाद) ऐसा नहीं किया जा सकेगा.
...
### मेरे प्रीपेड क्रेडिट बैलेंस में 0 डॉलर से ज़्यादा रकम होने के बावजूद, मेरा इस्तेमाल क्यों बंद हो गया?
...
### क्या प्रीपे क्रेडिट का इस्तेमाल, Gemini Enterprise Agent Platform जैसी Google Cloud की अन्य सेवाओं के लिए किया जा सकता है?

नहीं, प्रीपे क्रेडिट का इस्तेमाल सिर्फ़ Gemini API के लिए किया जा सकता है. Google Cloud की जिन अन्य सेवाओं का इस्तेमाल किया जाता है (जैसे, Compute, Storage, Gemini Enterprise Agent Platform) उनके लिए, [Cloud के स्टैंडर्ड बिलिंग साइकल](https://docs.cloud.google.com/billing/docs/how-to/billing-cycle?hl=hi) के हिसाब से बिल भेजा जाता है.
...
Gemini API के लिए, बैलेंस मैनेज करने और लेन-देन का इतिहास देखने का काम सीधे Google AI Studio के बिलिंग टैब में किया जाना चाहिए.

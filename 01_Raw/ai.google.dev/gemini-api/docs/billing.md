...
fetched_at: 2026-06-29T05:31:47.400690+00:00
...
في صفحة [المشاريع](https://aistudio.google.com/projects?hl=ar)، يمكنك الاطّلاع على مستوى مشروعك وخطة الفوترة ضِمن عمود *مستوى الفوترة*. تظهر أي إجراءات متعلقة بحالة الفوترة يجب اتّخاذها لأحد المشاريع في عمودَي *فئة الفوترة* أو *الحالة*:
...
يمكنك إجراء الدفع المسبق عن طريق [إضافة رصيد](#buy-credits) إلى حسابك أو إعداد ميزة [تعبئة الرصيد تلقائيًا](#auto-reload). بعد شراء الوحدات، تنتهي صلاحية الوحدات غير المستخدَمة بعد 12 شهرًا، وهي [غير قابلة للاسترداد](#refunds)، إلا بعد [التبديل إلى حساب بنظام الدفع الآجل](#postpay).

عندما يصل رصيد الدفع المُسبَق في حساب الفوترة إلى 0 دولار أمريكي، ستتوقّف جميع مفاتيح API في جميع المشاريع المرتبطة بحساب الفوترة هذا عن العمل في الوقت نفسه.
...
يتم تلقائيًا ضبط خطة الفوترة على "الدفع المسبق" للمستخدمين الجدد. قد تحتاج المشاريع التي تم إنشاؤها قبل طرح خطتَي الفوترة "الدفع المسبق" و"الدفع عند الاستخدام" إلى [تعديل تفاصيل الفوترة الخاصة بالمشروع](#verify-billing) قبل مواصلة استخدام Gemini API.
...
يمكن للحسابات التي لديها [أدوار](https://docs.cloud.google.com/iam/docs/roles-overview?hl=ar) محرّر المشروع أو مالكه أو مشرفه ضبط حدود الإنفاق القصوى لكل مشروع في AI Studio من خلال صفحة [الإنفاق](https://aistudio.google.com/spend?hl=ar) ضمن **حد الإنفاق الأقصى الشهري** > **تعديل حد الإنفاق الأقصى**.
...
يتم تحديد الفئات وحدود المعدّل وأقصى عدد للحسابات المرتبطة بنظام الفوترة على مستوى حساب الفوترة.
...
يمكنك [شراء وحدات](#buy-credits) من صفحة الفوترة في AI Studio. أثناء عملية الشراء، ستوفّر واجهة المستخدم الحد الأدنى لمبلغ الشراء المسبق المطلوب في منطقتك ومستوى اشتراكك، بالإضافة إلى الحد الأقصى للمبلغ الذي يمكن أن يكون في حسابك في وقت واحد.

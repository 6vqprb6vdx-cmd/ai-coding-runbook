...
fetched_at: 2026-06-08T15:08:03.095117+00:00
...
เริ่มสร้างได้โดยไม่มีค่าใช้จ่ายพร้อมโควต้าที่เพียงพอ จากนั้นจึงเพิ่มทรัพยากรด้วยการชำระเงินล่วงหน้าและราคาแบบจ่ายเมื่อใช้สำหรับแอปพลิเคชันที่พร้อมใช้งานจริง
...
- check\_circleเนื้อหาที่**ไม่ได้**ใช้เพื่อปรับปรุงผลิตภัณฑ์[\*](https://ai.google.dev/gemini-api/terms?hl=th)

[อัปเกรดเป็นแบบชำระเงิน](https://aistudio.google.com/api-keys?hl=th)

### Enterprise

สำหรับการติดตั้งใช้งานขนาดใหญ่ที่มีความต้องการด้านการรักษาความปลอดภัย การสนับสนุน และการปฏิบัติตามข้อกำหนดที่กำหนดเอง ซึ่งขับเคลื่อนโดย[แพลตฟอร์ม Agent ของ Gemini Enterprise](https://cloud.google.com/gemini-enterprise-agent-platform?hl=th)
...
โมเดลที่ชาญฉลาดที่สุดของเราสร้างขึ้นเพื่อเน้นความเร็ว โดยผสานรวมความชาญฉลาดระดับแนวหน้าเข้ากับ
...
| การเชื่อมต่อแหล่งข้อมูลกับ Google Search\* | ไม่พร้อมใช้งาน | พรอมต์ 5,000 รายการต่อเดือน (ฟรี ใช้ร่วมกันใน Gemini 3) จากนั้น $14 / การค้นหา 1,000 รายการ |
| การเชื่อมต่อแหล่งข้อมูลกับ Google Maps | ไม่พร้อมใช้งาน | พรอมต์ 5,000 รายการต่อเดือน (ฟรี ใช้ร่วมกันใน Gemini 3) จากนั้น $14 / การค้นหา 1,000 รายการ |
...
| การเชื่อมต่อแหล่งข้อมูลกับ Google Search\* | ไม่พร้อมใช้งาน | คำขอ 5,000 รายการต่อเดือน (ฟรี แชร์ใน Gemini 3) จากนั้น $14 / คำค้นหา 1,000 รายการ |
...
โมเดลที่มีประสิทธิภาพด้านต้นทุนมากที่สุดของเรา ซึ่งได้รับการเพิ่มประสิทธิภาพสำหรับงานที่ต้องใช้ Agent จำนวนมาก
...
## ตัวอย่าง Gemini 3.1 Flash Live
...
| การเชื่อมต่อแหล่งข้อมูลกับ Google Search\* | รองรับ | พรอมต์ 5,000 รายการต่อเดือน (ฟรี ใช้ร่วมกันใน Gemini 3) จากนั้น $14 / การค้นหา 1,000 รายการ |
| ใช้เพื่อปรับปรุงผลิตภัณฑ์ของเรา | [มี](https://ai.google.dev/gemini-api/terms?hl=th) | [ไม่](https://ai.google.dev/gemini-api/terms?hl=th) |
...
| ราคาเอาต์พุต | ไม่พร้อมใช้งาน | $3 (ข้อความและความคิด)  $60.00 (รูปภาพ)  เทียบเท่ากับ $0.045 ต่อรูปภาพ 0.5K\*  $0.067 ต่อรูปภาพ 1K\*, $0.101 ต่อรูปภาพ 2K\*, และ $0.151 ต่อรูปภาพ 4K\* |
| การเชื่อมต่อแหล่งข้อมูลกับ Google Search\*\* | ไม่พร้อมใช้งาน | พรอมต์ 5,000 รายการต่อเดือน (ฟรี แชร์ใน Gemini 3) จากนั้น $14 / 1,000 คำค้นหาสำหรับการอ้างอิงตามข้อความและรูปภาพ |
| ใช้เพื่อปรับปรุงผลิตภัณฑ์ของเรา | [มี](https://ai.google.dev/gemini-api/terms?hl=th) | [ไม่](https://ai.google.dev/gemini-api/terms?hl=th) |
...
รูปภาพเอาต์พุตที่ 1K (1024x1024 พิกเซล) จะใช้โทเค็น 1120 โทเค็นและมีค่าเท่ากับ $0.067 ต่อรูปภาพ รูปภาพเอาต์พุตที่ 2K (2048x2048 พิกเซล) จะใช้โทเค็น 1680 โทเค็นและ
...
\*\* คำขอที่ลูกค้าส่งไปยัง Gemini อาจทำให้เกิดการค้นหาใน Google Search อย่างน้อย 1 รายการ ระบบจะเรียกเก็บเงินจากคุณสำหรับคำค้นหาแต่ละรายการที่ดำเนินการ บริบทที่ดึงมา (ข้อความหรือรูปภาพ) ซึ่งได้จากการเชื่อมโยงกับ Google Search จะไม่ถูกเรียกเก็บเงินเป็นโทเค็นอินพุต
...
โมเดลเสียง 3.1 Flash Text-to-Speech ของเราได้รับการเพิ่มประสิทธิภาพเพื่อราคาที่คุ้มค่า
...
โมเดลการสร้างรูปภาพในตัวของเราได้รับการเพิ่มประสิทธิภาพเพื่อความเร็ว ความยืดหยุ่น และความเข้าใจตามบริบท **ข้อความที่ป้อนและเอาต์พุต**มีราคาเท่ากับ [Gemini 3.1 Pro](#gemini-3.1-pro-preview)
...
| การเชื่อมต่อแหล่งข้อมูลกับ Google Web Search และ Google Image Search\*\*\* | ไม่พร้อมใช้งาน | พรอมต์ 5,000 รายการต่อเดือน (ฟรี ใช้ร่วมกันใน Gemini 3) จากนั้น $14 / การค้นหา 1,000 รายการ |
| ใช้เพื่อปรับปรุงผลิตภัณฑ์ของเรา | [มี](https://ai.google.dev/gemini-api/terms?hl=th) | [ไม่](https://ai.google.dev/gemini-api/terms?hl=th) |
...
\*\*\* คำขอที่ลูกค้าส่งถึง Gemini อาจส่งผลให้มีการค้นหาใน Google Search อย่างน้อย 1 รายการ
ระบบจะเรียกเก็บเงินจากคุณสำหรับการค้นหาแต่ละรายการ
ที่ดำเนินการ
...
| การเชื่อมต่อแหล่งข้อมูลกับ Google Search | ไม่พร้อมใช้งาน | 1,500 RPD (ฟรี) จากนั้น $35 / 1,000 พรอมต์ที่ได้รับการกลั่นกรอง |
| การเชื่อมต่อแหล่งข้อมูลกับ Google Maps | ไม่พร้อมใช้งาน | 10,000 RPD (ฟรี) จากนั้น $25 / 1,000 พรอมต์ที่ได้รับการกลั่นกรอง |
| ใช้เพื่อปรับปรุงผลิตภัณฑ์ของเรา | [มี](https://ai.google.dev/gemini-api/terms?hl=th) | [ไม่](https://ai.google.dev/gemini-api/terms?hl=th) |
...
|  | รุ่นฟรี | ระดับแบบชำระเงินต่อโทเค็น 1 ล้านรายการในสกุลเงิน USD |
| --- | --- | --- |
| ราคาอินพุต | ไม่พร้อมใช้งาน | $0.625, พรอมต์ที่มีโทเค็นไม่เกิน 200,000 รายการ $1.25, พรอมต์ที่มีโทเค็นมากกว่า 200,000 รายการ |
...
| การเชื่อมต่อแหล่งข้อมูลกับ Google Search | ฟรี สูงสุด 500 RPD (จำกัดการแชร์กับ RPD ของ Flash-Lite) | 1,500 RPD (ฟรี โดยจำกัดการแชร์กับ RPD ของ Flash-Lite) จากนั้น $35 / 1,000 พรอมต์ที่อิงตามความจริง |
...
| ราคาการแคชบริบท | ไม่พร้อมใช้งาน | $0.03 (ข้อความ / รูปภาพ / วิดีโอ) $0.1 (เสียง) $1.00 / 1,000,000 โทเค็นต่อชั่วโมง (ราคาพื้นที่เก็บข้อมูล) |
| การเชื่อมต่อแหล่งข้อมูลกับ Google Search | ไม่พร้อมใช้งาน | 1,500 RPD (ฟรี โดยจำกัดการแชร์กับ RPD ของ Flash-Lite) จากนั้น $35 / 1,000 พรอมต์ที่อิงตามความจริง |
| การเชื่อมต่อแหล่งข้อมูลกับ Google Maps | ไม่พร้อมใช้งาน | ไม่พร้อมใช้งาน |
| ใช้เพื่อปรับปรุงผลิตภัณฑ์ของเรา | [มี](https://ai.google.dev/gemini-api/terms?hl=th) | [ไม่](https://ai.google.dev/gemini-api/terms?hl=th) |
...
| การเชื่อมต่อแหล่งข้อมูลกับ Google Search | ไม่มีค่าใช้จ่าย สูงสุด 500 RPD (จำกัดการแชร์กับ Flash RPD) | 1,500 RPD (ฟรี โดยมีโควต้าร่วมกับ Flash RPD) จากนั้น $35 / 1,000 พรอมต์ที่ได้รับการกลั่นกรอง |
| การเชื่อมต่อแหล่งข้อมูลกับ Google Maps | 500 RPD | 1,500 RPD (ฟรี) จากนั้น $25 / 1,000 พรอมต์ที่ได้รับการกลั่นกรอง |
| ใช้เพื่อปรับปรุงผลิตภัณฑ์ของเรา | [มี](https://ai.google.dev/gemini-api/terms?hl=th) | [ไม่](https://ai.google.dev/gemini-api/terms?hl=th) |
...
| ราคาการแคชบริบท | ไม่พร้อมใช้งาน | $0.01 (ข้อความ / รูปภาพ / วิดีโอ) $0.03 (เสียง) $1.00 / 1,000,000 โทเค็นต่อชั่วโมง (ราคาพื้นที่เก็บข้อมูล) |
| การเชื่อมต่อแหล่งข้อมูลกับ Google Search | ไม่พร้อมใช้งาน | 1,500 RPD (ฟรี โดยมีโควต้าร่วมกับ Flash RPD) จากนั้น $35 / 1,000 พรอมต์ที่ได้รับการกลั่นกรอง |
| การเชื่อมต่อแหล่งข้อมูลกับ Google Maps | ไม่พร้อมใช้งาน | ไม่พร้อมใช้งาน |
| ใช้เพื่อปรับปรุงผลิตภัณฑ์ของเรา | [มี](https://ai.google.dev/gemini-api/terms?hl=th) | [ไม่](https://ai.google.dev/gemini-api/terms?hl=th) |
...
โมเดลเสียงดั้งเดิมของ [Live API](https://ai.google.dev/gemini-api/docs/live?hl=th) ได้รับการเพิ่มประสิทธิภาพเพื่อเอาต์พุตเสียงคุณภาพสูงขึ้น
...
ความเข้าใจบริบท ระบบจะคิดราคาอินพุตและเอาต์พุตข้อความเหมือนกับ
...
โมเดลเสียงอ่านออกเสียงข้อความ 2.5 Flash ของเราได้รับการเพิ่มประสิทธิภาพเพื่อราคาที่คุ้มค่า
ความหน่วงต่ำ และการสร้างคำพูดที่ควบคุมได้
...
| การเชื่อมต่อแหล่งข้อมูลกับ Google Search | ไม่มีค่าใช้จ่าย สูงสุด 500 RPD | 1,500 RPD (ฟรี) จากนั้น $35 / 1,000 พรอมต์ที่ได้รับการกลั่นกรอง |
| การเชื่อมต่อแหล่งข้อมูลกับ Google Maps | 500 RPD | 1,500 RPD (ฟรี) จากนั้น $25 / 1,000 พรอมต์ที่ได้รับการกลั่นกรอง |
| ใช้เพื่อปรับปรุงผลิตภัณฑ์ของเรา | [มี](https://ai.google.dev/gemini-api/terms?hl=th) | [ไม่](https://ai.google.dev/gemini-api/terms?hl=th) |
...
| ราคาของวิดีโอ Veo 3.1 Lite พร้อมเสียง (ค่าเริ่มต้น) | ไม่พร้อมใช้งาน | $0.05 (720p) $0.08 (1080p) (ไม่รองรับเอาต์พุต 4K) |
| ใช้เพื่อปรับปรุงผลิตภัณฑ์ของเรา | [มี](https://ai.google.dev/gemini-api/terms?hl=th) | [ไม่](https://ai.google.dev/gemini-api/terms?hl=th) |
...
ตระกูลโมเดลการสร้างเพลงของ Google โมเดลเวอร์ชันตัวอย่างอาจมีการเปลี่ยนแปลงก่อนที่จะกลายเป็นเวอร์ชันเสถียรและมีขีดจำกัดอัตราการใช้งานที่เข้มงวดมากขึ้น
...
โมเดล Gemini Embeddings ของเราสำหรับ Use Case ที่เป็นข้อความเท่านั้น ซึ่งพร้อมให้บริการแก่นักพัฒนาซอฟต์แวร์ในระดับฟรีและระดับแบบชำระเงินของ Gemini API
...
| ราคาเอาต์พุต (รวมโทเค็นการคิด) | ไม่มีค่าใช้จ่าย | $5.00 |
| การเชื่อมต่อแหล่งข้อมูลกับ Google Search | ไม่พร้อมใช้งาน | พรอมต์ 5,000 รายการต่อเดือน (ฟรี โดยใช้โควต้าร่วมกับ Flash) จากนั้นคิดค่าบริการ $14 / 1,000 คำค้นหาสำหรับการอ้างอิงตามข้อความและรูปภาพ |
| ใช้เพื่อปรับปรุงผลิตภัณฑ์ของเรา | [มี](https://ai.google.dev/gemini-api/terms?hl=th) | [ไม่](https://ai.google.dev/gemini-api/terms?hl=th) |
...
| ราคาเอาต์พุต (รวมโทเค็นการคิด) | ไม่พร้อมใช้งาน | $2.50 |
| การเชื่อมต่อแหล่งข้อมูลกับ Google Search | ไม่พร้อมใช้งาน | ไม่พร้อมใช้งาน |
| ใช้เพื่อปรับปรุงผลิตภัณฑ์ของเรา | [มี](https://ai.google.dev/gemini-api/terms?hl=th) | [ไม่](https://ai.google.dev/gemini-api/terms?hl=th) |

## เวอร์ชันตัวอย่างการใช้งานคอมพิวเตอร์ของ Gemini 2.5
...
โมเดลแบบเปิดที่มีน้ำหนักเบาและล้ำสมัยของเราสร้างขึ้นจากเทคโนโลยีเดียวกัน
กับที่ขับเคลื่อนโมเดล Gemini
...
เครื่องมือมีราคาตามอัตราของตัวเอง ซึ่งจะนำไปใช้กับโมเดลที่ใช้เครื่องมือเหล่านั้น
ดูว่าเครื่องมือใดบ้างที่พร้อมใช้งานสำหรับแต่ละโมเดลได้ในหน้า[โมเดล](https://ai.google.dev/gemini-api/docs/models?hl=th)
...
| [Google Maps](https://ai.google.dev/gemini-api/docs/maps-grounding?hl=th#pricing_and_rate_limits) | 500 RPD ไม่พร้อมใช้งานสำหรับ Pro | RPD ฟรี 1,500 รายการ (จำกัดการแชร์สำหรับ Flash และ Flash-Lite) RPD ฟรี 10,000 รายการสำหรับ Pro จากนั้น $25 / 1,000 พรอมต์ที่อิงตามความจริง |
| [การเรียกใช้โค้ด](https://ai.google.dev/gemini-api/docs/code-execution?hl=th#billing) | ไม่มีค่าใช้จ่าย | ระบบจะเรียกเก็บเงินสำหรับการดำเนินการโค้ดตามอัตราโทเค็นมาตรฐานสำหรับโมเดลที่เลือก ค่าใช้จ่ายจะพิจารณาจากการใช้งานเครื่องมือเท่านั้น โดยจะไม่มีการเรียกเก็บเงิน สำหรับเวลาในการรันเซสชัน ระบบจะเรียกเก็บเงินสำหรับโค้ดที่สร้างขึ้นและผลการดำเนินการเป็น **โทเค็นเอาต์พุต**เมื่อสร้าง และเป็น **โทเค็นอินพุต**เมื่อโมเดลใช้โทเค็นเหล่านั้นเป็นส่วนหนึ่งของ กระบวนการให้เหตุผลแบบวนซ้ำ |
| [บริบทของ URL](https://ai.google.dev/gemini-api/docs/url-context?hl=th#limitations) | ไม่มีค่าใช้จ่าย | ระบบจะเรียกเก็บเงินเป็นโทเค็นอินพุตตามราคาของโมเดล |
| [การใช้คอมพิวเตอร์](https://ai.google.dev/gemini-api/docs/computer-use?hl=th) | ไม่พร้อมใช้งาน | ดูตารางราคาของ [Gemini 2.5 Computer Use Preview](#gemini-2.5-computer-use-preview-10-2025) |
| [การค้นหาไฟล์](https://ai.google.dev/gemini-api/docs/file-search?hl=th#pricing) | ไม่มีค่าใช้จ่าย | ระบบจะเรียกเก็บเงินสำหรับ[การฝัง](#gemini-embedding)ในราคา $0.15 / 1 ล้านโทเค็น ระบบจะเรียกเก็บเงินโทเค็นของเอกสารที่ดึงข้อมูลมาในฐานะโทเค็นปกติตามราคาของแต่ละโมเดล |
...
|  | รุ่น | เครื่องมือ |
| --- | --- | --- |
| [เอเจนต์ Gemini Deep Research](https://ai.google.dev/gemini-api/docs/deep-research?hl=th) | การอนุมานโมเดลทั้งหมดจะคิดค่าบริการตามราคาในรายการมาตรฐานของ Gemini ซึ่งรวมถึงโทเค็นอินพุต เอาต์พุต และอินพุต / การให้เหตุผลระดับกลางที่สร้างขึ้น ในระหว่างลูปของเอเจนต์ | ค่าธรรมเนียมการใช้เครื่องมือจะขึ้นอยู่กับโครงสร้างการกำหนดราคาที่มีอยู่ โดยจะยังคงความแตกต่างมาตรฐานสำหรับการอ้างอิงจาก Search (ไม่รวมโทเค็นที่ดึงข้อมูลมา) เทียบกับ Url\_context / File Search (รวมโทเค็นที่ดึงข้อมูลมาใน เครื่องมืออื่นๆ ทั้งหมด) |
| [Agent ที่ได้รับการจัดการใน Gemini API](https://ai.google.dev/gemini-api/docs/agents?hl=th) | การอนุมานโมเดลทั้งหมดจะมีการเรียกเก็บเงินตามอัตรามาตรฐานของ Gemini ซึ่งรวมถึงโทเค็นอินพุต เอาต์พุต และอินพุต / การให้เหตุผลระดับกลางที่สร้างขึ้น ในระหว่างลูปของเอเจนต์ (ดู[รายละเอียดราคา](https://ai.google.dev/gemini-api/docs/agents?hl=th#pricing)) | ระบบจะไม่เรียกเก็บเงินสำหรับการประมวลผลสภาพแวดล้อม (CPU, หน่วยความจำ, การดำเนินการในแซนด์บ็อกซ์) ในช่วงระยะเวลาแสดงตัวอย่าง |
| [Antigravity Agent](https://ai.google.dev/gemini-api/docs/antigravity-agent?hl=th) | การอนุมานโมเดลทั้งหมดจะมีการเรียกเก็บเงินตามอัตรามาตรฐานของ Gemini ซึ่งรวมถึงโทเค็นอินพุต เอาต์พุต และอินพุต / การให้เหตุผลระดับกลางที่สร้างขึ้น ในระหว่างลูปของเอเจนต์ (ดู[รายละเอียดราคา](https://ai.google.dev/gemini-api/docs/agents?hl=th#pricing)) | ระบบจะไม่เรียกเก็บเงินค่าการประมวลผลสภาพแวดล้อม (CPU, หน่วยความจำ, การดำเนินการในแซนด์บ็อกซ์) ในช่วงระยะเวลาแสดงตัวอย่าง |

## หมายเหตุ

- **การเรียกเก็บเงินตามโทเค็นเอกสาร:** ระบบจะเรียกเก็บเงินโทเค็นสำหรับรูปแบบ `DOCUMENT` (เช่น PDF) ตามอัตราโทเค็นรูปภาพ ในการตอบกลับจาก API โทเค็นเหล่านี้จะปรากฏในรูปแบบ `DOCUMENT` ภายใน `promptTokensDetails`
...
- หากคุณใช้[การดึงข้อมูลแบบไดนามิก](https://ai.google.dev/gemini-api/docs/grounding?hl=th)เพื่อเพิ่มประสิทธิภาพค่าใช้จ่าย ระบบจะเรียกเก็บเงินเฉพาะคำขอที่มี URL การสนับสนุนการเชื่อมต่อแหล่งข้อมูลอย่างน้อย 1 รายการจากเว็บในคำตอบสำหรับการเชื่อมต่อแหล่งข้อมูลกับ Google Search ส่วนค่าใช้จ่ายสำหรับ Gemini จะมีผลเสมอ และโควต้าอัตราอาจมีการเปลี่ยนแปลง

เนื้อหาของหน้าเว็บนี้ได้รับอนุญาตภายใต้[ใบอนุญาตที่ต้องระบุที่มาของครีเอทีฟคอมมอนส์ 4.0](https://creativecommons.org/licenses/by/4.0/) และตัวอย่างโค้ดได้รับอนุญาตภายใต้[ใบอนุญาต Apache 2.0](https://www.apache.org/licenses/LICENSE-2.0) เว้นแต่จะระบุไว้เป็นอย่างอื่น โปรดดูรายละเอียดที่[นโยบายเว็บไซต์ Google Developers](https://developers.google.com/site-policies?hl=th) Java เป็นเครื่องหมายการค้าจดทะเบียนของ Oracle และ/หรือบริษัทในเครือ

อัปเดตล่าสุด 2026-06-02 UTC

[[["เข้าใจง่าย","easyToUnderstand","thumb-up"],["แก้ปัญหาของฉันได้","solvedMyProblem","thumb-up"],["อื่นๆ","otherUp","thumb-up"]],[["ไม่มีข้อมูลที่ฉันต้องการ","missingTheInformationINeed","thumb-down"],["ซับซ้อนเกินไป/มีหลายขั้นตอนมากเกินไป","tooComplicatedTooManySteps","thumb-down"],["ล้าสมัย","outOfDate","thumb-down"],["ปัญหาเกี่ยวกับการแปล","translationIssue","thumb-down"],["ตัวอย่าง/ปัญหาเกี่ยวกับโค้ด","samplesCodeIssue","thumb-down"],["อื่นๆ","otherDown","thumb-down"]],["อัปเดตล่าสุด 2026-06-02 UTC"],[],[]]

...
fetched_at: 2026-08-31T06:41:09.237221+00:00
...
אפשר להתחיל לבנות בחינם עם מכסות נדיבות, ואז להרחיב את השימוש עם תשלום מראש או עם תשלום לפי שימוש עבור האפליקציות שמוכנות לייצור.
...
[אפשר לנסות את זה ב-Google AI Studio](https://aistudio.google.com?model=gemini-3.6-flash&hl=he)
...
| מחיר הפלט (כולל טוקנים של חשיבה) | בחינם | 30 ₪ |
| מחיר של שמירת נתונים במטמון בהקשר | בחינם | ‫0.15$ ‫1.00$למיליון טוקנים לשעה (מחיר אחסון) |
| עיגון באמצעות חיפוש Google\* | לא זמין\*\* | ‫5,000 בקשות חיפוש בחינם בחודש (משותפות לכל המודלים של Gemini 3.x), ואז 14 $לכל 1,000 בקשות. |
...
| מחיר הפלט (כולל טוקנים של חשיבה) | לא זמין | 3.75$‎ |
| מחיר של שמירת נתונים במטמון בהקשר | לא זמין | ‫0.075$ 1.00$ / 1,000,000 טוקנים לשעה (מחיר אחסון) |
| עיגון באמצעות חיפוש Google\* | לא זמין\*\* | ‫5,000 בקשות חיפוש בחינם בחודש (משותפות לכל המודלים של Gemini 3.x), ואז 14 $לכל 1,000 בקשות. |
...
| --- | --- | --- |
| מחיר קלט | בחינם | $2.70 |
| מחיר הפלט (כולל טוקנים של חשיבה) | בחינם | ‫13.50$ |
| מחיר של שמירת נתונים במטמון בהקשר | בחינם | ‫0.27$ 1.00$‎ / 1,000,000 טוקנים לשעה (מחיר אחסון) |
| עיגון באמצעות חיפוש Google\* | לא זמין\*\* | ‫5,000 בקשות חיפוש בחינם בחודש (משותפות לכל המודלים של Gemini 3.x), ואז 14 $לכל 1,000 בקשות. |
| עיגון בעזרת מפות Google | לא זמין\*\* | ‫5,000 הנחיות בחודש (בחינם, משותף ל-Gemini 3), ואז 14 $‎ לכל 1,000 שאילתות חיפוש |
| התרומה משמשת לשיפור המוצרים שלנו | [כן](https://ai.google.dev/gemini-api/terms?hl=he) | [לא](https://ai.google.dev/gemini-api/terms?hl=he) |
...
| מחיר קלט | לא זמין | 3.00 ש"ח |
| מחיר הפלט (כולל טוקנים של חשיבה) | לא זמין | 4.50$‎ |
| מחיר של שמירת נתונים במטמון בהקשר | לא זמין | ‫0.08$ 1.00$ / 1,000,000 טוקנים לשעה (מחיר אחסון) |
| עיגון באמצעות חיפוש Google\* | לא זמין\*\* | ‫5,000 בקשות חיפוש בחינם בחודש (משותפות לכל המודלים של Gemini 3.x), ואז 14 $לכל 1,000 בקשות. |
| עיגון בעזרת מפות Google | לא זמין\*\* | ‫5,000 בקשות לחודש (בחינם, משותף ל-Gemini 3), ואז 14 $‎ לכל 1,000 שאילתות חיפוש |
| התרומה משמשת לשיפור המוצרים שלנו | [כן](https://ai.google.dev/gemini-api/terms?hl=he) | [לא](https://ai.google.dev/gemini-api/terms?hl=he) |
...
‫\* החיוב מבוסס על צריכת טוקנים כוללת של קלט ופלט אודיו, שמחושבת לפי קצב של 25 טוקנים לשנייה של אודיו, ששווה למחיר בפועל של כ-0.0368 $לדקה.

## Gemini 3.5 Flash-Lite

*`gemini-3.5-flash-lite`*

[אפשר לנסות את זה ב-Google AI Studio](https://aistudio.google.com/prompts/new_chat?model=gemini-3.5-flash-lite&hl=he)

מודל ה-GA הכי חסכוני שלנו, שעבר אופטימיזציה לביצוע משימות אג'נטיות בהיקף גדול, לתרגום ולעיבוד נתונים פשוט.

### רגיל

|  | תוכנית בחינם | רמה בתשלום, לכל מיליון טוקנים בדולר ארה"ב |
| --- | --- | --- |
| מחיר קלט | בחינם | ‫0.30$ (טקסט / תמונה / סרטון / אודיו) |
| מחיר הפלט (כולל טוקנים של חשיבה) | בחינם | 10.00 ש"ח |
| מחיר של שמירת נתונים במטמון בהקשר | לא זמין | ‫0.03$ 1.00$‎ / 1,000,000 טוקנים לשעה (מחיר אחסון) |
| עיגון באמצעות חיפוש Google\* | לא זמין\*\* | ‫5,000 בקשות חיפוש בחינם בחודש (משותפות לכל המודלים של Gemini 3.x), ואז 14 $לכל 1,000 בקשות. |
| עיגון בעזרת מפות Google | לא זמין\*\* | ‫5,000 בקשות לחודש (בחינם, משותף ל-Gemini 3), ואז 14 $‎ לכל 1,000 שאילתות חיפוש |
| התרומה משמשת לשיפור המוצרים שלנו | [כן](https://ai.google.dev/gemini-api/terms?hl=he) | [לא](https://ai.google.dev/gemini-api/terms?hl=he) |
...
|  | תוכנית בחינם | רמה בתשלום, לכל מיליון טוקנים בדולר ארה"ב |
| --- | --- | --- |
| מחיר קלט | בחינם | ‫0.15$ (טקסט / תמונה / סרטון / אודיו) |
| מחיר הפלט (כולל טוקנים של חשיבה) | בחינם | 5.00 ש"ח |
| מחיר של שמירת נתונים במטמון בהקשר | לא זמין | ‫0.02$ 1.00$ / 1,000,000 טוקנים לשעה (מחיר אחסון) |
| עיגון באמצעות חיפוש Google\* | לא זמין\*\* | ‫5,000 בקשות חיפוש בחינם בחודש (משותפות לכל המודלים של Gemini 3.x), ואז 14 $לכל 1,000 בקשות. |
| עיגון בעזרת מפות Google | לא זמין\*\* | ‫5,000 הנחיות בחודש (בחינם, משותף ל-Gemini 3), ואז 14 $‎ לכל 1,000 שאילתות חיפוש |
| התרומה משמשת לשיפור המוצרים שלנו | [כן](https://ai.google.dev/gemini-api/terms?hl=he) | [לא](https://ai.google.dev/gemini-api/terms?hl=he) |
...
|  | תוכנית בחינם | רמה בתשלום, לכל מיליון טוקנים בדולר ארה"ב |
| --- | --- | --- |
| מחיר קלט | בחינם | ‫0.54$ (טקסט / תמונה / סרטון / אודיו) |
| מחיר הפלט (כולל טוקנים של חשיבה) | בחינם | 4.50$‎ |
| מחיר של שמירת נתונים במטמון בהקשר | לא זמין | ‫0.05$ 1.00$ / 1,000,000 טוקנים לשעה (מחיר אחסון) |
| עיגון באמצעות חיפוש Google\* | לא זמין\*\* | ‫5,000 בקשות חיפוש בחינם בחודש (משותפות לכל המודלים של Gemini 3.x), ואז 14 $לכל 1,000 בקשות. |
| עיגון בעזרת מפות Google | לא זמין\*\* | ‫5,000 הנחיות בחודש (בחינם, משותף ל-Gemini 3), ואז 14 $‎ לכל 1,000 שאילתות חיפוש |
| התרומה משמשת לשיפור המוצרים שלנו | [כן](https://ai.google.dev/gemini-api/terms?hl=he) | [לא](https://ai.google.dev/gemini-api/terms?hl=he) |
...
|  | תוכנית בחינם | רמה בתשלום, לכל מיליון טוקנים בדולר ארה"ב |
| --- | --- | --- |
| מחיר קלט | בחינם | ‫$0.25 (טקסט / תמונה / סרטון) ‫$0.50 (אודיו) |
| מחיר הפלט (כולל טוקנים של חשיבה) | בחינם | 6.00 ש"ח |
| מחיר של שמירת נתונים במטמון בהקשר | לא זמין | ‫0.025$ (טקסט / תמונה / סרטון) ‫0.05$ (אודיו) ‫1.00$למיליון טוקנים לשעה (מחיר אחסון) |
| עיגון באמצעות חיפוש Google\* | לא זמין\*\* | ‫5,000 בקשות חיפוש בחינם בחודש (משותפות לכל המודלים של Gemini 3.x), ואז 14 $לכל 1,000 בקשות. |
| עיגון בעזרת מפות Google | לא זמין\*\* | ‫5,000 הנחיות בחודש (בחינם, משותף ל-Gemini 3), ואז 14 $‎ לכל 1,000 שאילתות חיפוש |
| התרומה משמשת לשיפור המוצרים שלנו | [כן](https://ai.google.dev/gemini-api/terms?hl=he) | [לא](https://ai.google.dev/gemini-api/terms?hl=he) |
...
| מחיר של שמירת נתונים במטמון בהקשר | לא זמין | ‫0.0125$ (טקסט / תמונה / סרטון) ‫0.025$ (אודיו) ‫0.50$למיליון טוקנים לשעה (מחיר אחסון) |
| עיגון באמצעות חיפוש Google\* | לא זמין\*\* | ‫5,000 בקשות חיפוש בחינם בחודש (משותפות לכל המודלים של Gemini 3.x), ואז 14 $לכל 1,000 בקשות. |
| עיגון בעזרת מפות Google | לא זמין\*\* | ‫5,000 הנחיות בחודש (בחינם, משותף ל-Gemini 3), ואז 14 $‎ לכל 1,000 שאילתות חיפוש |
| התרומה משמשת לשיפור המוצרים שלנו | [כן](https://ai.google.dev/gemini-api/terms?hl=he) | [לא](https://ai.google.dev/gemini-api/terms?hl=he) |
...
| מחיר של שמירת נתונים במטמון בהקשר | לא זמין | ‫0.045$ (טקסט / תמונה / סרטון) ‫0.09$ (אודיו) ‫1.80$למיליון טוקנים לשעה (מחיר אחסון) |
| עיגון באמצעות חיפוש Google\* | לא זמין\*\* | ‫5,000 בקשות חיפוש בחינם בחודש (משותפות לכל המודלים של Gemini 3.x), ואז 14 $לכל 1,000 בקשות. |
| עיגון בעזרת מפות Google | לא זמין\*\* | ‫5,000 הנחיות בחודש (בחינם, משותף ל-Gemini 3), ואז 14 $‎ לכל 1,000 שאילתות חיפוש |
| התרומה משמשת לשיפור המוצרים שלנו | [כן](https://ai.google.dev/gemini-api/terms?hl=he) | [לא](https://ai.google.dev/gemini-api/terms?hl=he) |
...
| מחיר של שמירת נתונים במטמון בהקשר | לא זמין | ‫0.20$, הנחיות עם עד 200, 000 טוקנים ‫0.40$,הנחיות עם יותר מ-200,000 טוקנים ‫4.50$למיליון טוקנים לשעה (מחיר אחסון) |
| עיגון באמצעות חיפוש Google\* | לא זמין\*\* | ‫5,000 בקשות חיפוש בחינם בחודש (משותפות לכל המודלים של Gemini 3.x), ואז 14 $לכל 1,000 בקשות. |
| עיגון בעזרת מפות Google | לא זמין\*\* | ‫5,000 הנחיות בחודש (בחינם, משותף ל-Gemini 3), ואז 14 $‎ לכל 1,000 שאילתות חיפוש |
| התרומה משמשת לשיפור המוצרים שלנו | [כן](https://ai.google.dev/gemini-api/terms?hl=he) | [לא](https://ai.google.dev/gemini-api/terms?hl=he) |
...
| מחיר של שמירת נתונים במטמון בהקשר | לא זמין | *זהה ל-Standard*  ‫0.20$, הנחיות עם ‎200k tokens או פחות ‫0.40$, הנחיות עם יותר מ-‎200k tokens ‫4.50$למיליון tokens לשעה (מחיר אחסון) |
| עיגון באמצעות חיפוש Google\* | לא זמין\*\* | ‫5,000 בקשות חיפוש בחינם בחודש (משותפות לכל המודלים של Gemini 3.x), ואז 14 $לכל 1,000 בקשות. |
| עיגון בעזרת מפות Google | לא זמין\*\* | ‫5,000 בקשות לחודש (בחינם, משותף ל-Gemini 3), ואז 14 $‎ לכל 1,000 שאילתות חיפוש |
| התרומה משמשת לשיפור המוצרים שלנו | [כן](https://ai.google.dev/gemini-api/terms?hl=he) | [לא](https://ai.google.dev/gemini-api/terms?hl=he) |
...
| מחיר של שמירת נתונים במטמון בהקשר | לא זמין | ‫0.36$, הנחיות עם ‎200k טוקנים או פחות ‫0.72$, הנחיות עם יותר מ-‎200k טוקנים ‫8.10$למיליון טוקנים לשעה (מחיר אחסון) |
| עיגון באמצעות חיפוש Google\* | לא זמין\*\* | ‫5,000 בקשות חיפוש בחינם בחודש (משותפות לכל המודלים של Gemini 3.x), ואז 14 $לכל 1,000 בקשות. |
| עיגון בעזרת מפות Google | לא זמין\*\* | ‫5,000 הנחיות בחודש (בחינם, משותף ל-Gemini 3), ואז 14 $‎ לכל 1,000 שאילתות חיפוש |
| התרומה משמשת לשיפור המוצרים שלנו | [כן](https://ai.google.dev/gemini-api/terms?hl=he) | [לא](https://ai.google.dev/gemini-api/terms?hl=he) |
...
מודל אודיו לאודיו עם זמן אחזור נמוך, שעבר אופטימיזציה לדיאלוג בזמן אמת עם זיהוי ניואנסים אקוסטיים, דיוק מספרי ומודעות מולטי-מודאלית.
...
| עיגון באמצעות חיפוש Google\* | נתמך | ‫5,000 בקשות חיפוש בחינם לחודש (משותפות לכל המודלים של Gemini 3.x), ואז 14 $לכל 1,000 בקשות. |
| התרומה משמשת לשיפור המוצרים שלנו | [כן](https://ai.google.dev/gemini-api/terms?hl=he) | [לא](https://ai.google.dev/gemini-api/terms?hl=he) |
...
מודל יצירת התמונות Gemini 3.1 Flash מיועד למהירות וליעילות, והוא יעיל למתן תשובות מהירות ואינטראקטיביות ולתפוקה גבוהה.
...
| עיגון באמצעות חיפוש אינטרנט וחיפוש תמונות ב-Google\*\* | לא זמין\*\*\* | ‫5,000 בקשות חיפוש בחינם בחודש (משותפות לכל מודלי Gemini 3.x), ואז 14 $לכל 1,000 בקשות להצמדת טקסט ותמונות. |
| התרומה משמשת לשיפור המוצרים שלנו | [כן](https://ai.google.dev/gemini-api/terms?hl=he) | [לא](https://ai.google.dev/gemini-api/terms?hl=he) |
...
| מחיר הפלט | לא זמין | ‫1.50$ (טקסט וחשיבה)  ‫30.00$ (תמונות)  שווה ל-0.022 $לכל תמונה ברזולוציה של 0.5K‏\*  ‫0.034$ לכל תמונה ברזולוציה של 1K‏\*,  ‫0.050$ לכל תמונה ברזולוציה של 2K‏\*,  ו-0.076 $לכל תמונה ברזולוציה של 4K‏\*. |
| התרומה משמשת לשיפור המוצרים שלנו | [כן](https://ai.google.dev/gemini-api/terms?hl=he) | [לא](https://ai.google.dev/gemini-api/terms?hl=he) |

\* התמחור של פלט תמונה הוא 60 $למיליון טוקנים.
תמונות פלט ברזולוציה של 0.5K (512 פיקסלים) צורכות 747 טוקנים, והעלות שלהן היא 0.045 $לתמונה. תמונות פלט ברזולוציה של 1K‏ (1024x1024 פיקסלים) צורכות 1,120 טוקנים, והן שוות ל-0.067 $לכל תמונה. תמונות פלט באיכות 2K ‏ (2048x2048px) צורכות 1,680 טוקנים, והן שוות ל-0.101 $‎ לכל תמונה. תמונות פלט ברזולוציית 4K‏ (4096x4096px) צורכות 2,520 טוקנים, והעלות שלהן היא 0.151 $לכל תמונה.
...
מודל התמונות Gemini 3.1 Flash Lite נועד ליצירה ועריכה של תמונות עם זמן טעינה קצר במיוחד ועלות משתלמת. הוא מיועד להיות המודל היעיל ביותר במשפחת מודלים ליצירת תמונות.
...
| מחיר הפלט | לא זמין | ‫$0.75 (טקסט וחשיבה)  ‫$15.00 (תמונות)  שווה ל-0.0168 $‎ לכל תמונה ברזולוציה של 1K\* |
| התרומה משמשת לשיפור המוצרים שלנו | [כן](https://ai.google.dev/gemini-api/terms?hl=he) | [לא](https://ai.google.dev/gemini-api/terms?hl=he) |

\* מחיר הפלט של תמונות הוא 30 $לכל 1,000,000 טוקנים. תמונות שנוצרות ברזולוציה של 1K ‏ (1024x1024 פיקסלים) צורכות 1,120 טוקנים, והעלות שלהן היא 0.0336 $לתמונה.
...
מודל האודיו שלנו מסוג ‎3.1 Flash Text-to-Speech עבר אופטימיזציה כדי לספק ביצועים טובים במחיר משתלם, זמן אחזור נמוך ויצירת דיבור שניתן לשליטה.
...
| מחיר של שמירת נתונים במטמון בהקשר | בחינם | ‫0.05$ (טקסט / תמונה / סרטון) ‫0.10$ (אודיו) ‫1.00$‎ / 1,000,000 טוקנים לשעה (מחיר אחסון) |
| עיגון באמצעות חיפוש Google\* | לא זמין\*\* | ‫5,000 בקשות חיפוש בחינם בחודש (משותפות לכל המודלים של Gemini 3.x), ואז 14 $לכל 1,000 בקשות. |
| עיגון בעזרת מפות Google | לא זמין\*\* | ‫5,000 הנחיות בחודש (בחינם, משותף ל-Gemini 3), ואז 14 $‎ לכל 1,000 שאילתות חיפוש |
| התרומה משמשת לשיפור המוצרים שלנו | [כן](https://ai.google.dev/gemini-api/terms?hl=he) | [לא](https://ai.google.dev/gemini-api/terms?hl=he) |
...
|  | תוכנית בחינם | רמה בתשלום, לכל מיליון טוקנים בדולר ארה"ב |
| --- | --- | --- |
| מחיר קלט | לא זמין | ‫$0.25 (טקסט / תמונה / סרטון) ‫$0.50 (אודיו) |
| מחיר הפלט (כולל טוקנים של חשיבה) | לא זמין | 6.00 ש"ח |
| מחיר של שמירת נתונים במטמון בהקשר | לא זמין | *אותו מחיר כמו בגרסה הרגילה*  ‫0.05$ (טקסט / תמונה / סרטון)  ‫0.10$ (אודיו)  ‫1.00$ לכל מיליון טוקנים לשעה (מחיר האחסון) |
| עיגון באמצעות חיפוש Google\* | לא זמין\*\* | ‫5,000 בקשות חיפוש בחינם בחודש (משותפות לכל המודלים של Gemini 3.x), ואז 14 $לכל 1,000 בקשות. |
| עיגון בעזרת מפות Google | לא זמין\*\* | ‫5,000 בקשות לחודש (בחינם, משותף ל-Gemini 3), ואז 14 $‎ לכל 1,000 שאילתות חיפוש |
| התרומה משמשת לשיפור המוצרים שלנו | [כן](https://ai.google.dev/gemini-api/terms?hl=he) | [לא](https://ai.google.dev/gemini-api/terms?hl=he) |
...
| מחיר של שמירת נתונים במטמון בהקשר | בחינם | ‫0.09$ (טקסט / תמונה / סרטון) ‫0.18$ (אודיו) ‫1.80$למיליון טוקנים לשעה (מחיר אחסון) |
| עיגון באמצעות חיפוש Google\* | לא זמין\*\* | ‫5,000 בקשות חיפוש בחינם בחודש (משותפות לכל המודלים של Gemini 3.x), ואז 14 $לכל 1,000 בקשות. |
| עיגון בעזרת מפות Google | לא זמין\*\* | ‫5,000 הנחיות בחודש (בחינם, משותף ל-Gemini 3), ואז 14 $‎ לכל 1,000 שאילתות חיפוש |
| התרומה משמשת לשיפור המוצרים שלנו | [כן](https://ai.google.dev/gemini-api/terms?hl=he) | [לא](https://ai.google.dev/gemini-api/terms?hl=he) |
...
| עיגון באמצעות חיפוש Google\*\*\* | לא זמין\*\*\*\* | ‫5,000 בקשות חיפוש בחינם לחודש (משותפות לכל המודלים של Gemini 3.x), ואז 14 $לכל 1,000 בקשות. |
| התרומה משמשת לשיפור המוצרים שלנו | [כן](https://ai.google.dev/gemini-api/terms?hl=he) | [לא](https://ai.google.dev/gemini-api/terms?hl=he) |
...
\* קלט של תמונה מוגדר ל-560 טוקנים או ל-0.0011 $‎ לכל תמונה.

\*\* תמחור הפלט של התמונות הוא 120 $לכל 1,000,000 טוקנים. תמונות פלט ברזולוציה של ‎1,024x1,024px‏ (1K) ועד ‎2,048x2,048px‏ (2K) צורכות 1,120 טוקנים, והן שוות ל-0.134 $‎ לכל תמונה. תמונות פלט ברזולוציה של עד ‎4096x4096px‏ (4K) צורכות 2,000 טוקנים, והעלות שלהן היא 0.24 $לכל תמונה.
...
| מחיר של שמירת נתונים במטמון בהקשר | לא זמין | ‫0.125$, הנחיות של עד 200, 000 טוקנים ‫0.25$,הנחיות של יותר מ-200,000 טוקנים ‫4.50$לכל מיליון טוקנים לשעה (מחיר אחסון) |
...
|  | תוכנית בחינם | רמה בתשלום, לכל מיליון טוקנים בדולר ארה"ב |
| --- | --- | --- |
| מחיר קלט | בחינם | ‫2.25$, הנחיות עם ‎ <= 200k tokens ‫4.50$, הנחיות עם ‎ > 200k tokens |
| מחיר הפלט (כולל טוקנים של חשיבה) | בחינם | ‫18.00$, הנחיות עם ‎ <= 200k tokens ‫27.00$, הנחיות עם ‎ > 200k |
| מחיר של שמירת נתונים במטמון בהקשר | לא זמין | ‫0.225$, הנחיות עם עד 200, 000 טוקנים ‫0.45$,הנחיות עם יותר מ-200,000 טוקנים ‫8.10$למיליון טוקנים לשעה (מחיר אחסון) |
| עיגון באמצעות חיפוש Google | לא זמין | ‫1,500 RPD (בחינם), ואז 35 $לכל 1,000 הנחיות עם הארקה |
| עיגון בעזרת מפות Google | לא זמין | ‫10,000 RPD (בחינם), ואז $25 לכל 1,000 הנחיות מבוססות |
| התרומה משמשת לשיפור המוצרים שלנו | [כן](https://ai.google.dev/gemini-api/terms?hl=he) | [לא](https://ai.google.dev/gemini-api/terms?hl=he) |
...
| מחיר הפלט (כולל טוקנים של חשיבה) | בחינם | 10.00 ש"ח |
| מחיר של שמירת נתונים במטמון בהקשר | לא זמין | ‫0.03$ (טקסט / תמונה / סרטון) ‫0.1$ (אודיו) ‫1.00$למיליון טוקנים לשעה (מחיר אחסון) |
...
|  | תוכנית בחינם | רמה בתשלום, לכל מיליון טוקנים בדולר ארה"ב |
| --- | --- | --- |
| מחיר קלט | לא זמין | ‫0.60 ש"ח (טקסט / תמונה / סרטון) ‫2 ש"ח (אודיו) |
...
| מחיר הפלט (כולל טוקנים של חשיבה) | בחינם | 4.50$‎ |
| מחיר של שמירת נתונים במטמון בהקשר | לא זמין | ‫0.054$ (טקסט / תמונה / סרטון) ‫0.18$ (אודיו) ‫1.80$למיליון טוקנים לשעה (מחיר אחסון) |
| עיגון באמצעות חיפוש Google | ללא תשלום, עד 500 RPD (ההגבלה משותפת עם Flash-Lite RPD) | ‫1,500 RPD (בחינם, המגבלה משותפת עם Flash-Lite RPD), ואז 35 $‎ לכל 1,000 הנחיות שמוגבלות לקרקוע |
| עיגון בעזרת מפות Google | ‫500 RPD | ‫1,500 RPD (בחינם), ואז 25 $לכל 1,000 הנחיות עם הארקה |
| התרומה משמשת לשיפור המוצרים שלנו | [כן](https://ai.google.dev/gemini-api/terms?hl=he) | [לא](https://ai.google.dev/gemini-api/terms?hl=he) |
...
| מחיר של שמירת נתונים במטמון בהקשר | לא זמין | ‫0.01$ (טקסט / תמונה / סרטון) ‫0.03$ (אודיו) ‫1.00$למיליון טוקנים לשעה (מחיר אחסון) |
| עיגון באמצעות חיפוש Google | ללא תשלום, עד 500 RPD (ההגבלה משותפת עם Flash RPD) | ‫1,500 RPD (בחינם, המגבלה משותפת עם Flash RPD), ואז ‎ $35 / 1,000 הנחיות מבוססות |
| עיגון בעזרת מפות Google | ‫500 RPD | ‫1,500 RPD (בחינם), ואז 25 $לכל 1,000 הנחיות עם הארקה |
| התרומה משמשת לשיפור המוצרים שלנו | [כן](https://ai.google.dev/gemini-api/terms?hl=he) | [לא](https://ai.google.dev/gemini-api/terms?hl=he) |
...
| מחיר של שמירת נתונים במטמון בהקשר | לא זמין | ‫0.018$ (טקסט / תמונה / סרטון) ‫0.054$ (אודיו) ‫1.80$למיליון טוקנים לשעה (מחיר אחסון) |
| עיגון באמצעות חיפוש Google | ללא תשלום, עד 500 RPD (ההגבלה משותפת עם Flash RPD) | ‫1,500 RPD (בחינם, המגבלה משותפת עם Flash RPD), ואז ‎ $35 / 1,000 הנחיות מבוססות |
| עיגון בעזרת מפות Google | ‫500 RPD | ‫1,500 RPD (בחינם), ואז 25 $לכל 1,000 הנחיות עם הארקה |
| התרומה משמשת לשיפור המוצרים שלנו | [כן](https://ai.google.dev/gemini-api/terms?hl=he) | [לא](https://ai.google.dev/gemini-api/terms?hl=he) |
...
[ה-API של Live](https://ai.google.dev/gemini-api/docs/live?hl=he) כולל מודלים מקוריים של אודיו שעברו אופטימיזציה כדי לספק פלט אודיו באיכות גבוהה יותר, עם קצב דיבור טוב יותר, קול טבעי יותר, רמת פירוט גבוהה יותר ומצב רוח טוב יותר.
...
| מחיר של שמירת נתונים במטמון בהקשר | בחינם | ‫0.025$‎ / 1,000,000 טוקנים (טקסט/תמונה/סרטון) ‫0.175$‎ / 1,000,000 טוקנים (אודיו) |
...
| מחיר של שמירת נתונים במטמון בהקשר | לא זמין | ‫0.025$‎ / 1,000,000 טוקנים (טקסט/תמונה/סרטון) ‫0.175$‎ / 1,000,000 טוקנים (אודיו) |
| שמירת הקשר במטמון (אחסון) | לא זמין | ‫1.00$‎ / 1,000,000 טוקנים לשעה |
| תמחור של יצירת תמונות | לא זמין ([הושבת](https://ai.google.dev/gemini-api/docs/deprecations?hl=he#gemini-2.0-models)) | לא זמין ([הושבת](https://ai.google.dev/gemini-api/docs/deprecations?hl=he#gemini-2.0-models)) |
| מחיר הכוונון | לא זמין | לא זמין |
| עיגון באמצעות חיפוש Google | לא זמין | ‫1,500 RPD (בחינם), ואז 35 $לכל 1,000 הנחיות עם הארקה |
...
| מחיר של שמירת נתונים במטמון בהקשר | לא זמין | לא זמין |
...
| --- | --- | --- |
| מחיר של תמונות מהירות ב-Imagen 4 | לא זמין | $0.02 |
...
| מחיר קלט אודיו | לא זמין | ‫3.25$ (0.00008$ לשנייה) |
...
[אפשר לנסות את זה ב-Google AI Studio](https://aistudio.google.com?model=gemini-robotics-er-2-preview&hl=he)

‫Gemini Robotics ER 2, או Gemini Robotics Embodied Reasoning 2, הוא נקודת קצה של מודל ראייה ושפה שמאפשרת לרובוטים להבין את הסביבה שלהם בצורה מדויקת. המודל תומך בתיאום בין רובוטים, בהבנת התקדמות הסרטון, בשיתוף פעולה בין כמה רובוטים ובהסקת מסקנות מרחביות מתקדמות.

### רגיל

|  | תוכנית בחינם | רמה בתשלום, לכל מיליון טוקנים בדולר ארה"ב |
| --- | --- | --- |
| מחיר קלט | בחינם | ‫2.00$ (טקסט / תמונה / סרטון / אודיו) |
| מחיר הפלט (כולל טוקנים של חשיבה) | בחינם | 10.00$‎ |
| מחיר של שמירת נתונים במטמון בהקשר | לא זמין | ‫0.20$ ‫1.00$ / 1,000,000 טוקנים לשעה (מחיר אחסון) |
| עיגון באמצעות חיפוש Google | לא זמין | ‫5,000 בקשות חיפוש בחינם בחודש (משותפות לכל המודלים של Gemini 3.x), ואז 14 $לכל 1,000 בקשות. |
| התרומה משמשת לשיפור המוצרים שלנו | [כן](https://ai.google.dev/gemini-api/terms?hl=he) | [לא](https://ai.google.dev/gemini-api/terms?hl=he) |
...
|  | תוכנית בחינם | רמה בתשלום, לכל מיליון טוקנים בדולר ארה"ב |
| --- | --- | --- |
| מחיר קלט | לא זמין | ‫4.00 ש"ח (טקסט / תמונה / סרטון / אודיו) |
| מחיר הפלט (כולל טוקנים של חשיבה) | לא זמין | 20.00 ש"ח |
| מחיר של שמירת נתונים במטמון בהקשר | לא זמין | ‫0.10$ 1.00$‎ / 1,000,000 טוקנים לשעה (מחיר אחסון) |
| עיגון באמצעות חיפוש Google | לא זמין | ‫5,000 בקשות חיפוש בחינם בחודש (משותפות לכל המודלים של Gemini 3.x), ואז 14 $לכל 1,000 בקשות. |
| התרומה משמשת לשיפור המוצרים שלנו | [כן](https://ai.google.dev/gemini-api/terms?hl=he) | [לא](https://ai.google.dev/gemini-api/terms?hl=he) |
...
[אפשר לנסות את זה ב-Google AI Studio](https://aistudio.google.com?model=gemini-robotics-er-2-streaming-preview&hl=he)

‫Gemini Robotics ER 2 Streaming היא נקודת קצה של מודל ראייה ושפה לרובוטיקה, שעברה אופטימיזציה להזרמת טקסט בזמן אמת באמצעות Live API. הוא מקבל קלט של טקסט, תמונות, סרטונים ואודיו, ותומך בהזרמה דו-כיוונית עם קריאה לפונקציות.
...
‫Gemini Robotics ER, קיצור של Gemini Robotics-Embodied Reasoning, הוא מודל חשיבה שמשפר את היכולות של רובוטים להבין את העולם הפיזי ולקיים איתו אינטראקציה.
...
מודל השימוש במחשב שלנו עבר אופטימיזציה ליצירת סוכני בקרה בדפדפן שמבצעים משימות באופן אוטומטי.
...
| מחיר של שמירת נתונים במטמון בהקשר | בחינם | לא זמין |
...
המחירים של הכלים הם המחירים שלהם, והם חלים על המודל שמשתמשים בו.
בדף [Models](https://ai.google.dev/gemini-api/docs/models?hl=he) (מודלים) אפשר לראות אילו כלים זמינים לכל מודל.

|  | תוכנית בחינם | רמה בתשלום, לכל מיליון טוקנים בדולר ארה"ב |
| --- | --- | --- |
| [חיפוש Google](https://ai.google.dev/gemini-api/docs/google-search?hl=he#pricing) | ‫500 RPD בחינם (המגבלה משותפת ל-Flash ול-Flash-Lite). לא זמין ב-Pro. | מודלים של Gemini 2.5:  1,500 בקשות ליום בחינם (המגבלה משותפת ל-Flash ול-Flash-Lite). לאחר מכן, 35 $לכל 1,000 הנחיות עם הארקה   מודלים של Gemini 3:  5,000 בקשות חיפוש בחינם בחודש (משותף לכל המודלים של Gemini), ולאחר מכן 14 $לכל 1,000 בקשות. |
...
| [שימוש במחשב](https://ai.google.dev/gemini-api/docs/computer-use?hl=he) | לא זמין | החיוב הוא לפי מחיר רגיל של טוקנים לכל תמחור של מודל (למשל, תמחור רגיל של [Gemini 3.5 Flash](#gemini-3.6-flash)). בטבלת המחירים של [גרסת טרום-השקה של Gemini 2.5 לשימוש במחשב](#gemini-2.5-computer-use-preview-10-2025) מפורטים התעריפים של מודלים מדור קודם. |
...
|  | מודל | כלים |
| --- | --- | --- |
| [Gemini Deep Research agent](https://ai.google.dev/gemini-api/docs/deep-research?hl=he) | כל ההסקות של המודל מחויבות לפי התעריפים הרגילים של רשימת Gemini, כולל טוקנים של קלט, פלט וקלט ביניים / חשיבה רציונלית שנוצרו במהלך לולאות סוכן. | התשלום על השימוש בכלי הוא בהתאם למבנה התמחור הקיים, תוך שמירה על ההבחנות הרגילות בין Search Grounding (טוקנים שאוחזרו לא נכללים) לבין Url\_context / File Search (טוקנים שאוחזרו נכללים בכל שאר הכלים). |
| [ניהול סוכנים ב-Gemini API](https://ai.google.dev/gemini-api/docs/agents?hl=he) | כל ההסקות של המודל מחויבות לפי התעריפים הרגילים של רשימת Gemini, כולל טוקנים של קלט, פלט וקלט ביניים / חשיבה רציונלית שנוצרו במהלך לולאות סוכן. ([פרטים על התמחור](https://ai.google.dev/gemini-api/docs/agents?hl=he#pricing)) | לא נחייב על מחשוב בסביבה (CPU, זיכרון, הרצת ארגז חול) במהלך תקופת התצוגה המקדימה. |
| [Antigravity Agent](https://ai.google.dev/gemini-api/docs/antigravity-agent?hl=he) | כל ההסקות של המודל מחויבות לפי התעריפים הרגילים של רשימת Gemini, כולל טוקנים של קלט, פלט וקלט ביניים / חשיבה רציונלית שנוצרו במהלך לולאות סוכן. ([פרטים על התמחור](https://ai.google.dev/gemini-api/docs/agents?hl=he#pricing)) | לא נחייב על מחשוב בסביבה (CPU, זיכרון, הרצת ארגז חול) במהלך תקופת התצוגה המקדימה. |

## הערות

- **חיוב על טוקנים של מסמכים:** טוקנים של מצב `DOCUMENT` (לדוגמה, קובצי PDF) מחויבים לפי שיעור הטוקנים של תמונות. בתגובות מה-API, הטוקנים האלה מופיעים בקטע `DOCUMENT` modality בתוך `promptTokensDetails`.
...
- המחירים עשויים להיות שונים מהמחירים שמופיעים כאן ומהמחירים שמוצעים ב-Gemini Enterprise Agent Platform. מחירים של Gemini Enterprise Agent Platform מפורטים ב[דף המחירים של Gemini Enterprise Agent Platform](https://cloud.google.com/products/gemini-enterprise-agent-platform?hl=he).
- אם אתם משתמשים ב[אחזור דינמי](https://ai.google.dev/gemini-api/docs/grounding?hl=he) כדי לייעל את העלויות, תשלמו על עיגון באמצעות חיפוש Google רק על בקשות שהתשובה שלהן כוללת לפחות כתובת URL אחת של תמיכה בהארקה מהאינטרנט.
  העלויות של Gemini חלות תמיד. יכול להיות שיהיו שינויים במגבלות הקצב.

אלא אם צוין אחרת, התוכן של דף זה הוא ברישיון [Creative Commons Attribution 4.0](https://creativecommons.org/licenses/by/4.0/) ודוגמאות הקוד הן ברישיון [Apache 2.0](https://www.apache.org/licenses/LICENSE-2.0). לפרטים, ניתן לעיין ב[מדיניות האתר Google Developers‏](https://developers.google.com/site-policies?hl=he).‏ Java הוא סימן מסחרי רשום של חברת Oracle ו/או של השותפים העצמאיים שלה.

עדכון אחרון: 2026-08-11 (שעון UTC).

[[["התוכן קל להבנה","easyToUnderstand","thumb-up"],["התוכן עזר לי לפתור בעיה","solvedMyProblem","thumb-up"],["סיבה אחרת","otherUp","thumb-up"]],[["חסרים לי מידע או פרטים","missingTheInformationINeed","thumb-down"],["התוכן מורכב מדי או עם יותר מדי שלבים","tooComplicatedTooManySteps","thumb-down"],["התוכן לא עדכני","outOfDate","thumb-down"],["בעיה בתרגום","translationIssue","thumb-down"],["בעיה בדוגמאות/בקוד","samplesCodeIssue","thumb-down"],["סיבה אחרת","otherDown","thumb-down"]],["עדכון אחרון: 2026-08-11 (שעון UTC)."],[],[]]

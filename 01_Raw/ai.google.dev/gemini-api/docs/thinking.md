...
โมเดล [Gemini 3 และ 2.5 Series](https://ai.google.dev/gemini-api/docs/models?hl=th) ใช้
...
- **ให้คำแนะนำในการให้เหตุผล**: หากต้องการเอาต์พุตที่ยาวเป็นพิเศษ คุณอาจต้องให้คำแนะนำในพรอมต์เพื่อจำกัด[จำนวนการคิด](#set-budget)ที่โมเดลใช้ ซึ่งจะช่วยให้คุณสงวนโทเค็นเอาต์พุตไว้สำหรับคำตอบได้มากขึ้น
...
[คู่มือการคิด](https://colab.sandbox.google.com/github/google-gemini/cookbook/blob/main/quickstarts/Get_started_thinking.ipynb?hl=th)

...
fetched_at: 2026-09-07T05:39:58.105799+00:00
...
Gemini मॉडल को कॉन्फ़िगर करके, दिए गए JSON स्कीमा के मुताबिक जवाब जनरेट किए जा सकते हैं. इससे, टाइप-सेफ़ नतीजे मिलते हैं. साथ ही, बिना स्ट्रक्चर वाले टेक्स्ट से स्ट्रक्चर्ड डेटा निकालना आसान हो जाता है.
...
इस उदाहरण में, शर्तों के हिसाब से स्कीमा के लिए `anyOf` और क्लासिफ़िकेशन के लिए `enum` का इस्तेमाल दिखाया गया है. इससे, कॉन्टेंट के हिसाब से आउटपुट स्ट्रक्चर में बदलाव किया जा सकता है.
...
JSON ऑब्जेक्ट जनरेट करने के लिए, `response_format` को `text` टाइप के ऑब्जेक्ट (या ऑब्जेक्ट वाली किसी कलेक्शन) के साथ कॉन्फ़िगर करें. साथ ही, इसका `mime_type` को `application/json` पर सेट करें. `schema` फ़ील्ड में स्कीमा की जानकारी देनी चाहिए.
...
- **`object`**: की-वैल्यू पेयर वाले स्ट्रक्चर्ड डेटा के लिए.
- **`array`**: आइटम की सूची के लिए.
- **`null`**: किसी प्रॉपर्टी को नल के तौर पर दिखाने के लिए, टाइप कलेक्शन में `"null"` शामिल करें. उदाहरण के लिए, `{"type": ["string", "null"]}`.
...
- **`properties`**: एक ऑब्जेक्ट, जिसमें हर की एक प्रॉपर्टी का नाम होती है और हर वैल्यू उस प्रॉपर्टी के लिए एक स्कीमा होती है.
...
- **`format`**: स्ट्रिंग के लिए सिंटैक्स तय करता है. जैसे, `date-time`, `date`, `time`.

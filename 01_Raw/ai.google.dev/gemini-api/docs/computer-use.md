...
- **Politika ihlalleri:** API'nin özellikleri, Google'ın politikalarını ([Üretken Yapay Zeka Yasaklanan Kullanım Politikası](https://policies.google.com/terms/generative-ai/use-policy?hl=tr) ve [Gemini API Ek Hizmet Şartları](https://ai.google.dev/gemini-api/terms?hl=tr)) ihlal eden faaliyetlere yönlendirilebilir (kasıtlı veya kasıtsız olarak). Bu tanım, sistemin bütünlüğünü bozabilecek, güvenliği tehlikeye atabilecek, güvenlik önlemlerini atlayabilecek veya tıbbi cihazları kontrol edebilecek eylemleri içerir.

---
source_url: https://ai.google.dev/gemini-api/docs/generate-content/speech-generation?hl=th
fetched_at: 2026-08-10T03:25:32.120086+00:00
title: "\u0e01\u0e32\u0e23\u0e2a\u0e23\u0e49\u0e32\u0e07\u0e01\u0e32\u0e23\u0e2d\u0e48\u0e32\u0e19\u0e2d\u0e2d\u0e01\u0e40\u0e2a\u0e35\u0e22\u0e07\u0e02\u0e49\u0e2d\u0e04\u0e27\u0e32\u0e21 (TTS) \u00a0|\u00a0 Gemini Generate Content API (Legacy) \u00a0|\u00a0 Google AI for Developers"
---
...
ตรวจสอบว่าคุณใช้โมเดล Gemini ที่มีฟีเจอร์การอ่านออกเสียงข้อความ (TTS) ของ Gemini ตามที่ระบุไว้ในส่วน[โมเดลที่รองรับ](https://ai.google.dev/gemini-api/docs/speech-generation?hl=th#supported-models) โปรดพิจารณาว่าโมเดลใดเหมาะกับ Use Case เฉพาะของคุณมากที่สุดเพื่อให้ได้ผลลัพธ์ที่ดีที่สุด
...
และส่งออบเจ็กต์ `SpeechConfig` ที่ตั้งค่า `VoiceConfig` ไว้
...
คุณควบคุมสไตล์ น้ำเสียง สำเนียง และความเร็วได้โดยใช้พรอมต์ภาษาธรรมชาติ
หรือ[แท็กเสียง](#transcript-tags)สำหรับ TTS แบบลำโพงเดี่ยวและหลายลำโพง
...
โมเดล**การอ่านออกเสียงข้อความ (TTS) ของ Gemini Native Audio Generation** แตกต่างจากโมเดล TTS แบบเดิมตรงที่ใช้โมเดลภาษาขนาดใหญ่ที่***ไม่เพียงรู้ว่าจะพูดอะไร แต่ยังรู้วิธีพูดด้วย***

โมเดลจะตีความข้อความถอดเสียงโดยอัตโนมัติและกำหนดวิธี
ส่งคำพูดของคุณ ข้อความถอดเสียงแบบง่ายๆ โดยไม่ต้องมี
การแจ้งเตือนเพิ่มเติมจะฟังดูเป็นธรรมชาติ แต่ TTS ของ Gemini ยังมาพร้อมเครื่องมือที่คุณใช้เพื่อ
ควบคุมได้ด้วย
...
จากนั้นจะดู**โครงสร้างพรอมต์**ขั้นสูงเพื่อการกำหนดทิศทางประสิทธิภาพอย่างเต็มที่
...
ควรรู้สึกเหมือนเป็นส่วนหนึ่งของกิจกรรมชุมชนขนาดใหญ่ที่น่าตื่นเต้น"* ดีกว่าการพูดว่า*"กระตือรือร้นและมีพลัง"*
...
อธิบายสำเนียงที่ต้องการ ยิ่งเจาะจงมากเท่าไหร่ ผลลัพธ์ก็จะยิ่งดีขึ้นเท่านั้น เช่น ใช้ "*สำเนียงภาษาอังกฤษแบบอังกฤษที่ได้ยินในครอยดอน
...
ในวงเล็บเหลี่ยมที่ระบุวิธีพูดสิ่งต่างๆ การเปลี่ยน
...
Gemini พาคุณไปนั่งเก้าอี้ผู้กำกับ โปรดคำนึงถึงเคล็ดลับต่อไปนี้เพื่อสร้างการแสดงเสียงร้องที่ยอดเยี่ยม
...
คุณสามารถสตรีมเสียงที่สร้างขึ้นขณะที่โมเดลกำลังสร้างเสียง ซึ่งจะเป็นประโยชน์ในการลดเวลาในการตอบสนองที่รับรู้ได้
...
- TTS ไม่รองรับการสตรีมสำหรับโมเดลที่เก่ากว่าเวอร์ชัน 3.1 (`gemini-3.1-flash-tts-preview` และรุ่นที่ใหม่กว่ารองรับการสตรีม)
...
- **การแสดงผลโทเค็นข้อความเป็นครั้งคราว:** บางครั้งโมเดลจะแสดงผลโทเค็นข้อความแทนโทเค็นเสียง ซึ่งทำให้เซิร์ฟเวอร์ประมวลผลคำขอไม่สำเร็จและแสดงข้อผิดพลาด `500`
  เนื่องจากปัญหานี้เกิดขึ้นแบบสุ่มในคำขอบางส่วนเท่านั้น
  คุณจึงควรใช้ตรรกะการลองใหม่โดยอัตโนมัติในแอปพลิเคชันเพื่อจัดการ
  ปัญหาเหล่านี้

...
fetched_at: 2026-05-05T13:17:41.868061+00:00
...
Visualizar](https://ai.google.dev/gemini-api/docs/models/gemini-3.1-pro-preview?hl=pt-br)
[spark
...
Visualizar](https://ai.google.dev/gemini-api/docs/models/gemini-3-flash-preview?hl=pt-br)
[bolt
...
Visualizar](https://ai.google.dev/gemini-api/docs/models/gemini-3.1-flash-lite-preview?hl=pt-br)
[🍌🍌
...
Visualizar](https://ai.google.dev/gemini-api/docs/models/gemini-3.1-flash-image-preview?hl=pt-br)
[🍌
...
Visualizar](https://ai.google.dev/gemini-api/docs/models/gemini-3-pro-image-preview?hl=pt-br)
[settings\_voice
...
Nova visualização](https://ai.google.dev/gemini-api/docs/models/gemini-3.1-flash-live-preview?hl=pt-br)
[graphic\_eq
...
Nova visualização](https://ai.google.dev/gemini-api/docs/models/gemini-3.1-flash-tts-preview?hl=pt-br)
...
### [Pré-lançamento do Nano Banana 2](https://ai.google.dev/gemini-api/docs/models/gemini-3.1-flash-image-preview?hl=pt-br)
...
### [Pré-lançamento do Nano Banana Pro](https://ai.google.dev/gemini-api/docs/models/gemini-3-pro-image-preview?hl=pt-br)
...
### [Imagen 4](https://ai.google.dev/gemini-api/docs/models/imagen?hl=pt-br)
...
Um modelo de agente que planeja e executa de forma autônoma pesquisas de várias etapas em centenas de fontes para produzir relatórios interativos e citados.
...
### [Gemini Embedding 2](https://ai.google.dev/gemini-api/docs/models/gemini-embedding-2?hl=pt-br)
...
### [Gemini Embedding](https://ai.google.dev/gemini-api/docs/models/gemini-embedding-001?hl=pt-br)
...
Modelo de raciocínio incorporado avançado que entende espaços físicos e planeja tarefas de várias etapas para agentes robóticos com novos recursos, como leitura de instrumentos, raciocínio espacial e físico aprimorado.
...
### [Gemini 2.0 Flash descontinuado](https://ai.google.dev/gemini-api/docs/models/gemini-2.0-flash?hl=pt-br)
...
### [Gemini 2.0 Flash-Lite descontinuado](https://ai.google.dev/gemini-api/docs/models/gemini-2.0-flash-lite?hl=pt-br)

Nosso modelo de segunda geração mais rápido, otimizado para eficiência de custo e baixa latência.

restore

### [Pré-lançamento do Gemini 3 Pro desativado](https://ai.google.dev/gemini-api/docs/models/gemini-3-pro-preview?hl=pt-br)
...
Aponta para um modelo de pré-lançamento que pode ser usado na produção. Os modelos de pré-lançamento normalmente têm a cobrança ativada, podem vir com limites de taxa mais restritivos e serão descontinuados com pelo menos duas semanas de antecedência.

Por exemplo: `gemini-2.5-flash-preview-09-2025`.

### Mais recentes

Aponta para a versão mais recente de uma variação de modelo específica. Pode ser uma versão estável, de pré-lançamento ou experimental. Esse alias será trocado a quente com cada novo lançamento de uma variação de modelo específica. Um **aviso de duas semanas** será enviado por e-mail antes que a versão mais recente seja alterada.
...
Para informações sobre descontinuações de modelos, acesse a página de [descontinuações do Gemini](https://ai.google.dev/gemini-api/docs/deprecations?hl=pt-br).

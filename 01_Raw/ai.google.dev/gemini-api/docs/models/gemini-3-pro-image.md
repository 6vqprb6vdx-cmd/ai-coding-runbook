...
fetched_at: 2026-09-14T05:39:03.334356+00:00
title: "Gambar Gemini 3 Pro \u00a0|\u00a0 Gemini API \u00a0|\u00a0 Google AI for Developers"
---
...
**Nano Banana Pro** adalah mesin canggih berbasis penalaran untuk pengeditan dan pembuatan gambar tingkat profesional, yang menawarkan presisi berkualitas studio dan kontrol kreatif tingkat lanjut. Nano Banana Pro paling cocok untuk desain grafis yang kompleks, mockup produk dengan fidelitas tinggi, dan visualisasi data faktual yang memerlukan rendering teks yang akurat dan perujukan dunia nyata melalui Google Penelusuran.

[Coba di Google AI Studio](https://aistudio.google.com?model=gemini-3-pro-image&hl=id)

## Dokumentasi

Buka halaman [Pembuatan gambar](https://ai.google.dev/gemini-api/docs/image-generation?hl=id) untuk mengetahui cakupan lengkap fitur dan kemampuannya.

## gemini-3-pro-image

| Properti | Deskripsi |
| --- | --- |
| Kode model id\_card | `gemini-3-pro-image` |
...
| speedOpsi pemakaian | **[Batch API](https://ai.google.dev/gemini-api/docs/batch-api?hl=id)**  Didukung  **[Inferensi Flex](https://ai.google.dev/gemini-api/docs/flex-inference?hl=id)**  Tidak didukung  **[Inferensi prioritas](https://ai.google.dev/gemini-api/docs/priority-inference?hl=id)**  Tidak didukung |
| Versi 123 | Baca [pola versi model](https://ai.google.dev/gemini-api/docs/models/gemini?hl=id#model-versions) untuk mengetahui detail selengkapnya.  - Stabil: `gemini-3-pro-image` |
| calendar\_monthPembaruan terbaru | November 2025 |
| Kartu model id\_card | [Kartu model](https://deepmind.google/models/model-cards/gemini-3-pro-image/?hl=id) |

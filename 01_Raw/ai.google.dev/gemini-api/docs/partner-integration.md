...
Đối với các khung, việc triển khai [SDK GenAI của Google](https://ai.google.dev/gemini-api/docs/libraries?hl=vi)
...
- Truy cập vào phần tổng quan về thư viện [library overview](https://ai.google.dev/gemini-api/docs/libraries?hl=vi) để tìm hiểu về
  the GenAI SDKs
- Duyệt tài liệu tham khảo [API](https://ai.google.dev/api?hl=vi)

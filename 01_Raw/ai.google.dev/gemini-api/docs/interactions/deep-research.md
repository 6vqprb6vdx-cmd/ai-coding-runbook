...
fetched_at: 2026-05-25T13:03:32.225224+00:00
...
`stream=True` 및 `background=True`를 설정해야 합니다. 이벤트 유형, 도구 스트리밍, 사고방식 등 스트리밍에 관한 포괄적인 가이드는 [스트리밍 상호작용](https://ai.google.dev/gemini-api/docs/interactions/streaming?hl=ko)을 참고하세요.

...
fetched_at: 2026-05-04T17:08:02.243069+00:00
...
The Index’s [initial report](http://arxiv.org/abs/2503.04761) provides first-of-its-kind data and analysis based on millions of anonymized conversations on [Claude.ai](http://claude.ai/redirect/website.v1.85decebc-fc03-43b4-b4dd-2a03a0897f66), revealing the clearest picture yet of how AI is being incorporated into real-world tasks across the modern economy.
...
- We also only analyze data from [Claude.ai](http://claude.ai/redirect/website.v1.85decebc-fc03-43b4-b4dd-2a03a0897f66) Free and Pro plans, rather than API, Team, or Enterprise users. While Claude.ai data contains some non-work conversations, we used a language model to filter this data to only contain conversations relevant to an occupational task, which helps to mitigate this concern.

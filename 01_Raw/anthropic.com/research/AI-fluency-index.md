...
fetched_at: 2026-09-14T05:34:31.053912+00:00
title: "Anthropic Education Report: The AI Fluency Index \u00c2\u00b7 Claude Academy"
---
...
In line with our recent [Economic Index(opens in new tab)](https://www.anthropic.com/research/economic-index-primitives), we find that the most common expression of AI fluency is *augmentative*âtreating AI as a thought partner, rather than delegating work entirely. In fact, these conversations exhibit more than double the number of AI fluency behaviors than quick, back-and-forth chats.

But we also find that when AI produces artifactsâincluding apps, code, documents, or interactive toolsâusers are *less* likely to question its reasoning (-3.1 percentage points) or identify missing context (-5.2pp). This aligns with related patterns we observed in our [recent study on coding skills(opens in new tab)](https://www.anthropic.com/research/AI-assistance-coding-skills).

These initial findings present us with a baseline that we can use to study the development of AI fluency over time.

## Measuring AI fluency[î](#measuring-ai-fluency)

To quantify AI fluency, we use the [4D AI Fluency Framework(opens in new tab)](https://www.anthropic.com/collections/ai-fluency), developed by Professors Rick Dakan and Joseph Feller in collaboration with Anthropic. This framework helps us define 24 specific behaviors that we take to exemplify safe and effective human-AI collaboration.
...
### Fluency is strongly associated with conversations that exhibit iteration and refinement[î](#fluency-is-strongly-associated-with-conversations-that-exhibit-iteration-and-refinement)
...
On average, conversations with iteration and refinement exhibit 2.67 additional fluency behaviorsâroughly double the non-iterative rate of 1.33. This is especially pronounced for fluency behaviors related to evaluating Claude's outputs. Conversations with iteration and refinement are 5.6x more likely to involve users questioning Claude's reasoning, and 4x more likely to see them identify missing context.

### When creating outputs, users become more directive but less evaluative[î](#when-creating-outputs-users-become-more-directive-but-less-evaluative)
...
## Developing your own AI fluency[î](#developing-your-own-ai-fluency)

As with all skills, AI fluency is a matter of degreeâfor most of us, it's possible to develop our techniques much further. Based on the patterns in our data, there are three areas where we've found many users could improve their skills:
...
- **Binary classification:** For each conversation in our sample, we classify each behavior as either present or absent. But this likely misses significant nuanceâlike arguable or partial demonstrations of behaviors, or overlapping signals between them.
- **Implicit behaviors:** Users might demonstrate fluency behaviors mentally (such as fact-checking Claude's claims against their own knowledge) without expressing these behaviors in conversation. This seems especially relevant for our data on artifactsâusers might be evaluating Claude's outputs through testing and practical use, rather than through conversation-visible behaviors.
...
## Acknowledgements[î](#acknowledgements)
...
2. Behavioral indicators were calculated across a one-week sample (January 20â26, 2026) and held stable day-to-day, with most behaviors varying by only 1â5 percentage points. Saturday rates were slightly lower for some behaviors (e.g., iteration and refinement was 81.4% for Saturday compared to a weekday peak of 87.9%), suggesting modest differences in casual versus purposeful use, but no day showed meaningful structural deviation. Rates were also consistent across six languages (English, French, Spanish, Chinese, Japanese, and German), with most behaviors varying by 3 percentage points or fewer across language groups. Together, these findings suggest that the behavioral patterns captured here reflect consistent habits in how people engage with AI, rather than being artifacts of timing, day of week, or linguistic and cultural context.

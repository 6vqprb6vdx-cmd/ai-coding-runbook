...
fetched_at: 2026-09-14T05:34:36.431039+00:00
...
The Index’s [initial report](http://arxiv.org/abs/2503.04761) provides first-of-its-kind data and analysis based on millions of anonymized conversations on [Claude.ai](http://claude.ai/redirect/website.v1.eb4683e5-bec6-4ce4-857a-ca97e1579a65), revealing the clearest picture yet of how AI is being incorporated into real-world tasks across the modern economy.
...
- We also only analyze data from [Claude.ai](http://claude.ai/redirect/website.v1.eb4683e5-bec6-4ce4-857a-ca97e1579a65) Free and Pro plans, rather than API, Team, or Enterprise users. While Claude.ai data contains some non-work conversations, we used a language model to filter this data to only contain conversations relevant to an occupational task, which helps to mitigate this concern.
